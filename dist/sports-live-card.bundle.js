...
`;function ge(e){return"light"===(e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark")?"light":"dark"}function ue(e,t){const i=ge(t);return e&&e.setAttribute&&e.setAttribute("data-skin",i),i}const fe=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;");function me(e,t,i){let a=document.getElementById(e);return a||(a=document.createElement("div"),a.id=e,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.style.cssText="position:fixed;inset:0;display:flex;justify-content:center;align-items:center;z-index:999999;background:rgba(0,0,0,0.7);backdrop-filter:blur(8px);overflow:auto;",document.body.appendChild(a)),a._spClickHandler&&a.removeEventListener("click",a._spClickHandler),a._spKeyHandler&&document.removeEventListener("keydown",a._spKeyHandler),a._spClickHandler=e=>{e.target===a&&i()},a._spKeyHandler=e=>{"Escape"===e.key&&i()},a.addEventListener("click",a._spClickHandler),document.addEventListener("keydown",a._spKeyHandler),function(e,t){e.style.setProperty("--p-bg",t?"#ffffff":"#1a1f2e"),e.style.setProperty("--p-panel",t?"rgba(15,23,42,0.05)":"rgba(255,255,255,0.04)"),e.style.setProperty("--p-text",t?"#14182a":"#f8fafc"),e.style.setProperty("--p-sub",t?"#5b6577":"#94a3b8"),e.style.setProperty("--p-border",t?"rgba(15,23,42,0.10)":"rgba(255,255,255,0.08)"),e.style.setProperty("--p-muted","#cbd5e1")}(a,t),a}function ve(e){const t=document.getElementById(e);t&&(t._spKeyHandler&&document.removeEventListener("keydown",t._spKeyHandler),t._spClickHandler&&t.removeEventListener("click",t._spClickHandler),t.remove())}const be="data:image/svg+xml;utf8,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M16 8 H48 V32 C48 46 40 54 32 58 C24 54 16 46 16 32 Z" fill="#9aa3af" stroke="#6b7280" stroke-width="2"/></svg>');function xe(e){return e&&String(e).trim()?e:be}const _e=`this.onerror=null;this.src='${be}'`,ye=(e,t)=>Array.from({length:t-e+1},((t,i)=>e+i)),we={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:ye(1,8),europa:ye(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:ye(1,8),europa:ye(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:ye(1,8),europa:ye(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("sports-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},showPopup:{type:Boolean},activeTeam:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.compact=!0===e.compact,this.highlightTeam=e.highlight_team||"",this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null,this.showPopup=!1,this.activeTeam=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),ve("sports-live-standings-popup"),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass?.connection&&(this._eventSubscriptions=[],["sports_live_score","sports_live_discipline","sports_live_match_finished"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleSportsLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)})).catch((()=>{}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",i=e.competition_code;if(!i)return!1;const a=i.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(a)}_handleSportsLiveEvent(e){const t=e.event_type,i=e.data;this._eventBelongsToThisCard(i)&&this.showEventToasts&&this._showEventToast(t,i)}_showEventToast(e,t){let i="",a="goal";const s=t.minute&&"N/A"!==t.minute?` (${t.minute}')`:"";if("sports_live_score"===e)i=`<strong>${(t.score_event_label||this._t("event.goal")).toUpperCase()}!</strong> ${t.player&&"N/A"!==t.player?`${t.player} · `:""}${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="goal";else if("sports_live_discipline"===e){const e=String(t.discipline_type||"").toUpperCase();"YELLOW"===e?(i=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${s}`,a="yellow"):"RED"===e&&(i=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${s}`,a="red")}else"sports_live_match_finished"===e&&(i=`<strong>${this._t("status.full_time")}</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="finished");i&&(this._toastMessage=i,this._toastVariant=a,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}showTeamDetails(e){this.activeTeam=e,this.showPopup=!0}updated(e){(e.has("showPopup")||e.has("activeTeam"))&&this._renderTeamPopupToBody()}_renderTeamPopupToBody(){if(!this.showPopup||!this.activeTeam)return void ve("sports-live-standings-popup");const e=this.activeTeam,t=e=>this._t(e),i=this._sport(),a=["nba","nhl","mlb","nfl"].includes(i),s=e=>{const t=parseInt(String(e??"").replace("+",""),10);return isNaN(t)?null:t},n=me("sports-live-standings-popup","light"===ge(this._config),(()=>{this.showPopup=!1})),o=s(e.wins),r=s(e.draws),l=s(e.losses),c=null!==o&&null!==l?o+(r||0)+l:null,d=s(e.goal_difference),p=null===d?"—":d>0?`+${d}`:`${d}`,h=null===d?"var(--p-sub)":d>0?"#10b981":d<0?"#ef4444":"var(--p-sub)",g=e=>null==e||""===e||"N/A"===e?null:e,u=function(e,t){return`<div style="background:var(--p-panel);padding:12px 8px;border-radius:12px;text-align:center;">\n        <div style="font-size:18px;font-weight:900;color:${arguments.length>2&&void 0!==arguments[2]?arguments[2]:"var(--p-text)"};font-variant-numeric:tabular-nums;">${t??"—"}</div>\n        <div style="font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:var(--p-sub);margin-top:3px;">${e}</div>\n      </div>`};let f;if(a){const a=g(e.playoff_seed)?`<div style="font-size:11px;font-weight:700;color:var(--p-sub);margin-top:2px;">Seed #${e.playoff_seed}</div>`:"";f=`\n        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:18px;">\n          ${u(t("col.wins"),o,"#10b981")}\n          ${u(t("col.losses"),l,"#ef4444")}\n          ${u(t("nhl"===i?"col.otl":"col.pct"),g("nhl"===i?e.ot_losses:e.win_pct))}\n        </div>\n        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:18px;">\n          ${u(t("col.gb"),g(e.games_behind))}\n          ${u(t("col.streak"),g(e.streak))}\n          ${u(t("nhl"===i?"col.points":"col.gd"),"nhl"===i?g(e.points):null===d?null:p,h)}\n        </div>\n        ${a}`}else f=`\n        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:18px;">\n          ${u(t("col.played"),c)}\n          ${u(t("col.wins"),o,"#10b981")}\n          ${u(t("col.draws"),r,"#f59e0b")}\n          ${u(t("col.losses"),l,"#ef4444")}\n        </div>\n        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:18px;">\n          ${u(t("col.gf"),g(e.goals_for))}\n          ${u(t("col.ga"),g(e.goals_against))}\n          ${u(t("col.gd"),p,h)}\n        </div>`;const m=String(e.form||"").replace(/[^WLDwld]/g,"").toUpperCase().slice(-5),v={W:"#10b981",L:"#ef4444",D:"#f59e0b"},b=m?m.split("").map((e=>`<div style="width:22px;height:22px;border-radius:6px;background:${v[e]||"#475569"};color:white;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:800;">${e}</div>`)).join(""):"";n.innerHTML=`\n      <div style="background:var(--p-bg);padding:24px;border-radius:20px;width:90%;max-width:480px;max-height:85vh;overflow-y:auto;border:1px solid var(--p-border);box-shadow:0 24px 64px rgba(0,0,0,0.6);margin:auto;color:var(--p-text);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;">\n          <img src="${xe(e.team_logo)}" onerror="${_e}" style="width:64px;height:64px;object-fit:contain;filter:drop-shadow(0 4px 12px rgba(0,0,0,0.4));" />\n          <div>\n            <div style="font-size:20px;font-weight:900;letter-spacing:-0.02em;">${e.team_name}</div>\n            <div style="font-size:11px;font-weight:700;color:var(--p-sub);margin-top:4px;">${t("col.pos")} #${e.rank} · ${e.points??"—"} ${t("col.points")}</div>\n          </div>\n        </div>\n\n        ${f}\n\n        ${b?`\n        <div style="margin-bottom:18px;padding:14px;background:var(--p-panel);border-radius:12px;">\n          <div style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:var(--p-sub);margin-bottom:8px;">${t("team.form")} (${t("team.last5")})</div>\n          <div style="display:flex;gap:6px;">${b}</div>\n        </div>`:""}\n\n        <button id="standings-popup-close" style="background:linear-gradient(135deg,#6366f1,#ec4899);color:white;padding:12px 20px;border:none;border-radius:12px;cursor:pointer;margin-top:4px;font-weight:800;width:100%;font-size:14px;">${t("generic.close")}</button>\n      </div>`,n.querySelector("#standings-popup-close").onclick=()=>{this.showPopup=!1}}getCardSize(){return 5}static getConfigElement(){return document.createElement("sports-live-classifica-editor")}static getStubConfig(){return{entity:"",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&we[this._config.zone_preset])return we[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,i=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(we))if(t.match&&t.match(i,e))return t;return null}_positionInZone(e,t,i){if(!i)return!1;const a=String(i).match(/^bottom(\d+)$/);if(a){const i=parseInt(a[1],10);return t&&e>t-i}return!!Array.isArray(i)&&i.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const i=this._getZoneConfig();return this._positionInZone(e,t,i.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,i.europa)?"zone-el":this._positionInZone(e,t,i.conference)?"zone-conf":this._positionInZone(e,t,i.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let i=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(i=i.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),i.forEach(((e,t)=>{e.rank=t+1}))):i=i.slice().sort(((e,t)=>e.rank-t.rank)),i}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return U``;const e=this._config.entity,t=this.hass.states[e];if(!t)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const i=t.attributes.season||"",a=t.attributes.standings_groups||[],s=a.some((e=>(e.standings||[]).length>0));if(!s)return U`<ha-card class="empty">
      ...
      </ha-card>`;const n=!this.selectedGroup&&a.length>1,o=this._currentGroup(a),r=this._sortStandings(o?o.standings:[],i),l=r.length,c=48*Math.min(this.maxTeamsVisible,l)+50;return U`
      <ha-card>
        ...
        ${this.hideHeader?"":this._renderHeader(t,i,o,a,n)}

        ${n?this._renderGroupsGrid(a,i):U`
    ...
    `}_renderHeader(e,t,i,a,s){const n=this._getZoneConfig(),o=this._isCupGroupStage(),r=n&&n.hero?n.hero:null,l=s?this._t("phase.group_stage"):this._shouldShowPhase(i&&i.name)?this._translatePhase(i.name):"",c=[];t&&"n/a"!==t.toLowerCase()&&c.push(t),l&&c.push(l);let d=0;if(s)for(const e of a)d+=(e.standings||[]).filter((e=>null!=e.rank)).length;return U`
    ...
    `}_renderLegend(){const e=this._getZoneConfig(),t=this._getZoneLabels(),i=[{key:"champions",dot:"cl",positions:e.champions,label:t.champions},{key:"europa",dot:"el",positions:e.europa,label:t.europa},{key:"conference",dot:"conf",positions:e.conference,label:t.conference},{key:"relegation",dot:"rel",positions:e.relegation,label:t.relegation}].filter((e=>e.label&&this._hasZonePositions(e.positions)));return i.length?U`
      <div class="legend">
        ${i.map((e=>U`
    ...
    `:""}_renderGroupsGrid(e,t){const i=this._isCupGroupStage();return U`
      <div class="groups-grid ${i?"groups-grid-cup":""}">
        ${e.map((e=>{const i=this._sortStandings(e.standings||[],t),a=this._groupHasNoMatches(i);return U`
            <div class="group-cell ${a?"group-cell-pending":""}">
              <div class="group-title">
                <span>${e.name}</span>
                ${a?U`<span class="group-pending-badge">${this._t("hero.not_started")}</span>`:""}
              </div>
              ${this._renderCompactTable(i,i.length)}
            </div>
          `}))}
      </div>
    ...
    `}}),customElements.define("sports-live-matches",class extends oe{static get properties(){return{hass:{},_config:{},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_recentEventMatches:{type:Object},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}constructor(){super(),this._recentEventMatches=new Map,this._eventSubscriptions=[],this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null,this._pendingFocusKey=null,this._appliedFocusKey=void 0,this._lastScrollActivity=0,this._focusIdleTimer=null}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxEventsVisible=e.max_events_visible?e.max_events_visible:5,this.maxEventsTotal=e.max_events_total?e.max_events_total:50,this.showFinishedMatches=void 0===e.show_finished_matches||e.show_finished_matches,this.hideHeader=void 0!==e.hide_header&&e.hide_header,this.hidePastDays=void 0!==e.hide_past_days?e.hide_past_days:0,this.reverseOrder=!0===e.reverse_order,this.showEventToasts=!0===e.show_event_toasts,this.showVenue=!0===e.show_venue,this.showOdds=!0===e.show_odds,this.activeMatch=null,this.showPopup=!1}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents(),this._clockTick=setInterval((()=>{if("undefined"!=typeof document&&"hidden"===document.visibilityState)return;const e=this.hass?.states?.[this._config?.entity];(e?.attributes?.matches||[]).some((e=>"in"===e.state&&e.clock&&"N/A"!==e.clock))&&this.requestUpdate()}),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._clockTick&&(clearInterval(this._clockTick),this._clockTick=null),this._focusIdleTimer&&(clearTimeout(this._focusIdleTimer),this._focusIdleTimer=null),ve("sports-live-matches-popup"),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){if(!this.hass?.connection)return;this._eventSubscriptions=[];let e=!1;const t=t=>{this.hass.connection.subscribeEvents(this._handleSportsLiveEvent.bind(this),t).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)})).catch((()=>{e||(e=!0,this._setupStateChangedFallback())}))};t("sports_live_score"),t("sports_live_discipline")}_setupStateChangedFallback(){this.hass?.connection&&this.hass.connection.subscribeEvents((e=>{if(e.data.entity_id!==this._config?.entity)return;const t=e.data.new_state?.attributes?.matches||[],i=e.data.old_state?.attributes?.matches||[];t.forEach((e=>{if("in"!==e.state)return;const t=i.find((t=>t.home_team===e.home_team&&t.away_team===e.away_team));if(!t)return;const a={home_team:e.home_team,away_team:e.away_team,home_score:e.home_score,away_score:e.away_score,player:"N/A",score_event_label:null};String(e.home_score)!==String(t.home_score)&&this._handleSportsLiveEvent({event_type:"sports_live_score",data:{...a,team:e.home_team}}),String(e.away_score)!==String(t.away_score)&&this._handleSportsLiveEvent({event_type:"sports_live_score",data:{...a,team:e.away_team}})}))}),"state_changed").then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)})).catch((()=>{}))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];return!!t&&(t.attributes.matches||[]).some((t=>t.home_team===e.home_team&&t.away_team===e.away_team))}_handleSportsLiveEvent(e){const t=e.event_type,i=e.data;if(!this._eventBelongsToThisCard(i))return;const a=`${i.home_team}_${i.away_team}`;this._recentEventMatches.set(a,"sports_live_score"===t?"goal":"card"),this.requestUpdate(),setTimeout((()=>{this._recentEventMatches.delete(a),this.requestUpdate()}),5e3),this.showEventToasts&&this._showEventToast(t,i)}_showEventToast(e,t){let i="",a="goal";if("sports_live_score"===e)i=`<strong>${(t.score_event_label||this._t("event.goal")).toUpperCase()}!</strong> ${t.player&&"N/A"!==t.player?`${t.player} · `:""}${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="goal";else if("sports_live_discipline"===e){const e=String(t.discipline_type||"").toUpperCase(),s=t.minute&&"N/A"!==t.minute?` (${t.minute}')`:"";"YELLOW"===e?(i=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${s}`,a="yellow"):"RED"===e&&(i=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${s}`,a="red")}i&&(this._toastMessage=i,this._toastVariant=a,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 4}static getConfigElement(){return document.createElement("sports-live-matches-editor")}static getStubConfig(){return{entity:"",max_events_visible:5,max_events_total:50,hide_past_days:0,show_finished_matches:!0,hide_header:!1,show_event_toasts:!1,show_venue:!1,show_odds:!1}}_parseMatchDate(e){if(!e)return null;const[t,i]=e.split(" "),[a,s,n]=t.split("/").map(Number),[o,r]=i?i.split(":").map(Number):[0,0];return new Date(n,s-1,a,o,r)}_advanceClock(e,t){const i=Math.floor((Date.now()-new Date(t).getTime())/1e3);if(i<0||i>300)return e;if(e.includes(":")){const t=e.split(":");if(2!==t.length)return e;const a=60*parseInt(t[0],10)+parseInt(t[1],10);if(isNaN(a))return e;const s=a+i;return`${Math.floor(s/60)}:${(s%60).toString().padStart(2,"0")}`}const a=e.match(/^(\d+)'$/);return a?`${parseInt(a[1],10)+Math.floor(i/60)}'`:e}_matchTimeLabel(e){if("in"===e.state){const t=e.clock&&"N/A"!==e.clock?e.clock:"";if(t){const e=this.hass?.states?.[this._config?.entity],i=e?.last_updated;return i?this._advanceClock(t,i):t}return"LIVE"}if("post"===e.state)return"FT";if(e.date){const t=e.date.split(" ");return t[1]||t[0]}return"—"}_matchScore(e,t){return"pre"===e.state?"-":e["home"===t?"home_score":"away_score"]??"-"}_penaltyScore(e,t){return e.decided_on_penalties?"home"===t?e.penalty_home_score:e.penalty_away_score:null}_isWinner(e,t){if("pre"===e.state)return null;const i=parseInt(e.home_score),a=parseInt(e.away_score);if(!isNaN(i)&&!isNaN(a)&&i!==a)return"home"===t?i>a:a>i;if(e.decided_on_penalties&&null!=e.penalty_home_score&&null!=e.penalty_away_score){const i=e.penalty_home_score,a=e.penalty_away_score;if(i!==a)return"home"===t?i>a:a>i}return null}_dayKey(e){if(!e.date)return"—";const t=this._parseMatchDate(e.date);if(!t)return e.date.split(" ")[0]||"—";const i=new Date;i.setHours(0,0,0,0);const a=new Date(t);a.setHours(0,0,0,0);const s=Math.round((a-i)/864e5);if(0===s)return"⚡ "+this._t("time.today");if(-1===s)return this._t("time.yesterday");if(1===s)return this._t("time.tomorrow");const n=this._t("month."+(a.getMonth()+1));return`${a.getDate()} ${n}`}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],i=[],a=[],s=[],n=[],o=[],r=[];return e.forEach((e=>{const l=String(e||""),c=l.toLowerCase();c.startsWith("try")?s.push(this.formatMatchEvent(l)):c.startsWith("conversion")?n.push(this.formatMatchEvent(l)):c.startsWith("penalty goal")||c.startsWith("penalty - scored")?o.push(this.formatMatchEvent(l)):c.startsWith("drop goal")?r.push(this.formatMatchEvent(l)):c.includes("goal")?t.push(this.formatMatchEvent(l)):c.includes("yellow card")?i.push(this.formatMatchEvent(l)):c.includes("red card")&&a.push(this.formatMatchEvent(l))})),{goals:t,yellowCards:i,redCards:a,tries:s,conversions:n,penaltyGoals:o,dropGoals:r}}formatMatchEvent(e){const t=e=>this._t(e);let i=String(e||"").trim();i=i.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Try\s*-\s*/i,"").replace(/^Conversion\s*-\s*/i,"").replace(/^Penalty Goal\s*-\s*/i,"").replace(/^Drop Goal\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),i=i.replace(/^([^:]+):\s*/,"$1 ");const a=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return i=i.replace(new RegExp(`^(${a.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,i)=>`${i} (${t.toLowerCase()})`)),i=i.replace(/\bN\/A\b/g,t("generic.unknown")),i}_getBroadcast(e){const t=this._config?.broadcast_region||"uk",i=e.broadcast_uk&&"N/A"!==e.broadcast_uk?e.broadcast_uk:"",a=e.broadcast&&"N/A"!==e.broadcast&&""!==e.broadcast?e.broadcast:"";return"us"===t?a||i:"both"===t?[i,a].filter(Boolean).join(" / ")||"":i||a}_getVenue(e){return e.venue&&"N/A"!==e.venue?e.venue:""}_matchKeyOf(e){return`${e.home_team}_${e.away_team}`}_computeFocusMatch(e){const t=e.find((e=>"in"===e.state));if(t)return t;const i=e.filter((e=>"pre"===e.state)).map((e=>({m:e,d:this._parseMatchDate(e.date)}))).filter((e=>e.d)).sort(((e,t)=>e.d-t.d));return i.length?i[0].m:null}_windowAroundFocus(e,t,i){if(!i||e.length<=i)return e;const a=t?e.findIndex((e=>this._matchKeyOf(e)===this._matchKeyOf(t))):-1;if(-1===a)return e.slice(0,i);let s=Math.ceil((i-1)/2),n=i-1-s;const o=a,r=e.length-a-1;return s>o&&(n+=s-o,s=o),n>r&&(s+=n-r,n=r),s=Math.min(s,o),n=Math.min(n,r),e.slice(a-s,a+n+1)}_onUserScroll(){this._lastScrollActivity=Date.now(),this._focusIdleTimer&&clearTimeout(this._focusIdleTimer),this._focusIdleTimer=setTimeout((()=>{this._scrollToFocus(),this._appliedFocusKey=this._pendingFocusKey}),18e3)}_scrollToFocus(){let e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0];if(!this.shadowRoot||!this._pendingFocusKey)return;const t=this.shadowRoot.querySelector(".scroll-content");let i;try{i=this.shadowRoot.querySelector(`[data-match-key="${CSS.escape(this._pendingFocusKey)}"]`)}catch(e){i=null}t&&i?requestAnimationFrame((()=>{requestAnimationFrame((()=>{const a=t.getBoundingClientRect(),s=i.getBoundingClientRect(),n=Math.max(0,t.scrollTop+(s.top-a.top)-4);t.scrollTo({top:n,behavior:e?"smooth":"auto"}),console.debug("[sports-live-matches] scrolled to focus",{key:this._pendingFocusKey,targetScrollTop:n,containerScrollTop:t.scrollTop,containerScrollHeight:t.scrollHeight,containerClientHeight:t.clientHeight})}))})):console.debug("[sports-live-matches] scroll-to-focus skipped: missing container or row",{hasContainer:!!t,hasRow:!!i,key:this._pendingFocusKey})}render(){if(!this.hass||!this._config)return U``;const e=this._config.entity,t=this.hass.states[e];if(!t)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;let i=t.attributes.matches||[];const a=t.attributes.league_info?t.attributes.league_info[0]:null,s=t.attributes.team_logo||null;if(this.showFinishedMatches||(i=i.filter((e=>"Full Time"!==e.status))),i=i.slice().sort(((e,t)=>(this._parseMatchDate(e.date)||new Date(0))-(this._parseMatchDate(t.date)||new Date(0)))),this.hidePastDays>0){const e=new Date;e.setDate(e.getDate()-this.hidePastDays),i=i.filter((t=>{const i=this._parseMatchDate(t.date);return!i||i>=e}))}const n=this._computeFocusMatch(i);let o=this._windowAroundFocus(i,n,this.maxEventsTotal);if(this.reverseOrder&&(o=o.slice().reverse()),0===o.length)return this._pendingFocusKey=null,U`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const r=o.filter((e=>"in"===e.state)).length,l=this._computeFocusMatch(o);this._pendingFocusKey=l?this._matchKeyOf(l):null;const c=[];let d=null;o.forEach((e=>{const t=this._dayKey(e);t!==d?(d=t,c.push({key:t,matches:[e]})):c[c.length-1].matches.push(e)}));const p=Math.max(80*this.maxEventsVisible,240);return U`
      <ha-card>
        ...
        ${this.hideHeader?"":U`
          <div class="matches-header">
            ${a&&a.logo_href?U`<img class="league-logo" src="${a.logo_href}" alt="${a.abbreviation||""}" />`:s?U`<img class="league-logo" src="${s}" alt="" />`:""}
            <div class="league-info">
              <div class="league-name">${a&&a.abbreviation||t.state||"Sports Live"}</div>
              <div class="league-dates">
                ${a&&a.startDate?`${a.startDate} → ${a.endDate}`:this._t("generic.matches_count",{n:o.length})}
              </div>
            </div>
            ${r>0?U`<span class="live-counter">${r} LIVE</span>`:""}
          </div>
        `}

        <div class="scroll-content" style="max-height: ${p}px;" @scroll="${this._onUserScroll}">
          ${c.map((e=>U`
            <div class="day-divider ${e.key.startsWith("⚡")?"today":""}">${e.key}</div>
            ${e.matches.map((e=>{const t=this._matchKeyOf(e),i="in"===e.state,a=this._recentEventMatches.get(t),s=this._isWinner(e,"home"),n=this._isWinner(e,"away"),o=this._getBroadcast(e),r=this.showVenue?this._getVenue(e):"",l="pre"===e.state,c=e.decided_on_penalties,d=e.in_penalty_shootout,p=this._penaltyScore(e,"home"),h=this._penaltyScore(e,"away"),g=o&&(l||i)||r||c||d;return U`
                <div class="match-row ${i?"live":""} ${"goal"===a?"goal-pulse":""} ${"card"===a?"card-pulse":""}"
                  ...
                  <div class="match-teams">
                    <div class="match-team">
                      <img src="${xe(e.home_logo)}" onerror="${_e}" alt="${e.home_team}" />
                      <span class="name ${!0===s?"winner":!1===s?"loser":""}">${e.home_team}</span>
                      <span class="score ${!0===s?"winner":!1===s?"loser":""}">${this._matchScore(e,"home")}${null!=p?U`<span class="pen-score-inline">(${p}P)</span>`:""}</span>
                    </div>
                    <div class="match-team">
                      <img src="${xe(e.away_logo)}" onerror="${_e}" alt="${e.away_team}" />
                      <span class="name ${!0===n?"winner":!1===n?"loser":""}">${e.away_team}</span>
                      <span class="score ${!0===n?"winner":!1===n?"loser":""}">${this._matchScore(e,"away")}${null!=h?U`<span class="pen-score-inline">(${h}P)</span>`:""}</span>
                    </div>
                    ${g?U`
                      <div class="row-extras">
                        ...
                        `:""}
                        ${c?U`<span class="pen-chip">🎯 Penalties</span>`:""}
                        ${d?U`<span class="pen-chip live-pen">🎯 Shootout</span>`:""}
                      </div>
                    `:""}
                  </div>
    ...
    `}updated(e){if((e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody(),this._pendingFocusKey!==this._appliedFocusKey){const e=void 0===this._appliedFocusKey,t=this._lastScrollActivity?Date.now()-this._lastScrollActivity:1/0;(e||t>=18e3)&&(this._scrollToFocus(!e),this._appliedFocusKey=this._pendingFocusKey)}}renderPopupToBody(){if(!this.showPopup||!this.activeMatch)return void ve("sports-live-matches-popup");const e=this.activeMatch,t=e=>this._t(e),i=me("sports-live-matches-popup","light"===ge(this._config),(()=>{this.showPopup=!1})),a=e.decided_on_penalties||!1,s=e.in_penalty_shootout||!1,n=e.penalty_home_score,o=e.penalty_away_score,r=a&&null!=n&&null!=o?`<div style="font-size:13px;color:#fbbf24;font-weight:800;margin-top:6px;letter-spacing:0.03em;">🎯 Pens: ${fe(String(n))} – ${fe(String(o))}</div>`:s?'<div style="font-size:13px;color:#ef4444;font-weight:800;margin-top:6px;animation:pulse 1s infinite;">🎯 Penalty Shootout</div>':"";let l=null;a&&null!=n&&null!=o&&(l=n>o?e.home_team:e.away_team);const c=l?`<div id="matches-advances-banner" style="margin-bottom:16px;padding:10px 16px;background:rgba(16,185,129,0.12);border:1px solid rgba(16,185,129,0.3);border-radius:10px;text-align:center;font-size:14px;font-weight:800;">\n           🏆 <strong>${fe(l)}</strong> advances on penalties\n         </div>`:"";i.innerHTML=`\n      <div style="background:var(--p-bg);padding:24px;border-radius:20px;width:90%;max-width:560px;max-height:85vh;overflow-y:auto;border:1px solid var(--p-border);box-shadow:0 24px 64px rgba(0,0,0,0.6);margin:auto;color:var(--p-text);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <h3 style="margin:0 0 20px;font-size:22px;font-weight:800;letter-spacing:-0.02em;background:linear-gradient(135deg,#6366f1,#ec4899);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;">${fe(t("popup.match_details"))}</h3>\n        <div style="display:flex;justify-content:center;align-items:center;gap:18px;margin-bottom:12px;">\n          <img style="width:64px;height:64px;object-fit:contain;" src="${fe(xe(e.home_logo))}" onerror="${_e}" alt="${fe(e.home_team)}" />\n          <div style="text-align:center;">\n            <div style="font-size:38px;font-weight:900;letter-spacing:-0.04em;line-height:1;">${fe(e.home_score??"-")} <span style="opacity:0.4;">-</span> ${fe(e.away_score??"-")}</div>\n            ${r}\n            <div style="font-size:12px;color:var(--p-sub);margin-top:8px;font-weight:600;">${fe(e.clock??e.status??"")}</div>\n          </div>\n          <img style="width:64px;height:64px;object-fit:contain;" src="${fe(xe(e.away_logo))}" onerror="${_e}" alt="${fe(e.away_team)}" />\n        </div>\n        <p style="text-align:center;color:var(--p-muted);font-size:14px;margin:0 0 16px;"><strong>${fe(e.home_team)}</strong> vs <strong>${fe(e.away_team)}</strong></p>\n        ${c}\n        <div id="matches-info-container"></div>\n        <div id="matches-shootout-container"></div>\n        <div id="matches-events-container"></div>\n        ${e.event_url?`\n          <button id="matches-popup-espn" style="background:var(--p-panel);color:var(--p-text);border:1px solid var(--p-border);padding:10px 20px;border-radius:12px;cursor:pointer;margin-top:8px;font-weight:700;width:100%;font-size:13px;">${fe(t("popup.view_on_espn"))}</button>\n        `:""}\n        <button id="matches-popup-close" style="background:linear-gradient(135deg,#6366f1,#ec4899);color:white;padding:12px 20px;border:none;border-radius:12px;cursor:pointer;margin-top:8px;font-weight:800;width:100%;font-size:14px;">${fe(t("generic.close"))}</button>\n      </div>\n    `,i.querySelector("#matches-popup-close").onclick=()=>{this.showPopup=!1};const d=i.querySelector("#matches-popup-espn");d&&(d.onclick=()=>{window.open(e.event_url,"_blank","noopener,noreferrer")});const p=i.querySelector("#matches-info-container"),h=(e,t)=>`\n      <div style="display:flex;justify-content:space-between;gap:12px;font-size:13px;padding:7px 0;border-bottom:1px solid var(--p-border);">\n        <span style="color:var(--p-sub);font-weight:600;">${fe(e)}</span>\n        <span style="color:var(--p-text);text-align:right;">${fe(t)}</span>\n      </div>\n    `;let g="";this._getVenue(e)&&(g+=h(t("popup.venue"),e.venue_city?`${e.venue}, ${e.venue_city}`:e.venue));const u=this._getBroadcast(e);u&&(g+=h(t("popup.tv"),u)),e.attendance&&(g+=h(t("popup.attendance"),Number(e.attendance).toLocaleString())),e.home_record&&(g+=h(e.home_abbrev||e.home_team,e.home_record)),e.away_record&&(g+=h(e.away_abbrev||e.away_team,e.away_record)),this.showOdds&&e.odds_details&&(g+=h(t("popup.odds"),e.odds_details)),this.showOdds&&null!=e.over_under&&(g+=h(t("popup.over_under"),e.over_under)),p.innerHTML=g?`<div style="margin-bottom:16px;">${g}</div>`:"";const f=i.querySelector("#matches-shootout-container");if(a||s){const t=e.home_abbrev||e.home_team.slice(0,3).toUpperCase(),i=e.away_abbrev||e.away_team.slice(0,3).toUpperCase(),r=null!=n&&null!=o?n>o?e.home_team:e.away_team:null,l=e=>{if(!e)return'<div style="display:flex;flex-direction:column;align-items:center;gap:2px;"><div style="width:22px;height:22px;border-radius:50%;background:rgba(148,163,184,0.12);border:1.5px dashed rgba(148,163,184,0.25);"></div><div style="height:9px;"></div></div>';const t=e.scored?"#10b981":"#ef4444",i=e.scored?"rgba(16,185,129,0.4)":"rgba(239,68,68,0.4)",a=e.scored?"✓":"✕",s=(e.player||"").split(" ").slice(-1)[0]||"";return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px;"><div title="${fe(e.player||"")}" style="width:22px;height:22px;border-radius:50%;background:${t};display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:900;box-shadow:0 2px 6px ${i};">${a}</div><div style="font-size:7.5px;color:var(--p-sub);width:30px;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${fe(e.player||"")}">${fe(s)}</div></div>`},c=a=>{const c=a.filter((t=>t.team===e.home_team)),d=a.filter((t=>t.team===e.away_team)),p=Math.max(c.length,d.length),h=(e,t,i,a,s)=>{const n=Array.from({length:p},((e,t)=>i[t]||null)),o=s?"#10b981":"var(--p-text)";return`<div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;border-radius:10px;${s?"background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.22);":"background:rgba(255,255,255,0.03);border:1px solid transparent;"}"><img src="${fe(xe(t))}" onerror="${_e}" style="width:26px;height:26px;object-fit:contain;flex-shrink:0;margin-top:3px;" /><span style="font-size:11px;font-weight:900;letter-spacing:0.04em;min-width:34px;padding-top:5px;">${fe(e)}</span>${null!=a?`<span style="font-size:17px;font-weight:900;color:${o};min-width:22px;text-align:center;padding-top:2px;">[${a}]</span>`:'<span style="min-width:22px;padding-top:2px;"></span>'}<div style="display:flex;gap:5px;flex-wrap:wrap;">${n.map(l).join("")}</div>${s?'<span style="margin-left:auto;padding-top:2px;font-size:14px;flex-shrink:0;">🏆</span>':""}</div>`},g=s?"#ef4444":"#fbbf24",u=s?"animation:pulse 1s infinite;":"",m=s?"⬤ Penalty Shootout":"🎯 Penalty Shootout";f.innerHTML=`\n          <div style="margin-bottom:16px;background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.18);border-radius:12px;padding:12px 14px;">\n            <div style="font-size:10px;font-weight:800;color:${g};text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;${u}">${m}</div>\n            ${h(t,e.home_logo,c,n,r===e.home_team)}\n            <div style="height:5px;"></div>\n            ${h(i,e.away_logo,d,o,r===e.away_team)}\n          </div>\n        `},d=e.shootout_details||[],p=this.hass?.states?.[this._config?.entity]?.attributes||{},h=a&&e.event_id&&p.competition_code&&p.sport?`https://site.api.espn.com/apis/site/v2/sports/${p.sport}/${p.competition_code}/summary?event=${e.event_id}`:null;d.length>0?c(d):h?(f.innerHTML='<div style="margin-bottom:16px;background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.18);border-radius:12px;padding:12px 14px;text-align:center;font-size:12px;color:#fbbf24;font-weight:700;">🎯 Loading shootout data…</div>',fetch(h).then((e=>e.json())).then((e=>{const t=[];for(const i of e.shootout||[])for(const e of i.shots||[])t.push({team:i.team,player:e.player||"",scored:!!e.didScore,_n:e.shotNumber||0});t.sort(((e,t)=>e._n-t._n)),c(t)})).catch((()=>c([])))):c([])}const m=i.querySelector("#matches-events-container"),{goals:v,yellowCards:b,redCards:x,tries:_,conversions:y,penaltyGoals:w,dropGoals:$}=this.separateEvents(e.match_details||[]),k=(e,t,i)=>t.length?`<div style="margin-bottom:14px;padding:14px;background:${i.bg};border-left:3px solid ${i.border};border-radius:10px;">\n        <h5 style="margin:0 0 8px;font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:${i.border};font-weight:800;">${fe(e)}</h5>\n        <ul style="margin:0;padding-left:18px;font-size:13px;color:var(--p-text);">${t.map((e=>`<li style="margin:4px 0;">${fe(e)}</li>`)).join("")}</ul>\n      </div>`:"";let C="";C+=k(t("event.goal"),v,{bg:"rgba(99,102,241,0.1)",border:"#6366f1"}),C+=k(t("event.yellow_card"),b,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),C+=k(t("event.red_card"),x,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"}),C+=k(t("event.try"),_,{bg:"rgba(16,185,129,0.1)",border:"#10b981"}),C+=k(t("event.conversion"),y,{bg:"rgba(16,185,129,0.07)",border:"#34d399"}),C+=k(t("event.penalty_goal"),w,{bg:"rgba(251,191,36,0.1)",border:"#fbbf24"}),C+=k(t("event.drop_goal"),$,{bg:"rgba(99,102,241,0.07)",border:"#818cf8"}),m.innerHTML=C||`<p style="text-align:center;color:var(--p-sub);font-size:13px;">${fe(t("popup.no_events"))}</p>`}static get styles(){return[he,n`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.detail.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.checked;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.value;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=parseInt(t.value,10);isNaN(a)||this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>{if(!e.startsWith("sensor."))return!1;const t=this.hass.states[e]?.attributes;return void 0!==t?.sport&&Array.isArray(t?.matches)})).sort())}render(){if(!this._config||!this.hass)return U``;const e=this._config.entity||"";return e&&this.entities.includes(e),U`
      <div class="card-config">
        ...
        <div class="option">
          ...
          <ha-switch
            .checked=${!0===this._config.show_venue}
    ...
    `}}),customElements.define("sports-live-team",class extends oe{static get properties(){return{hass:{},_config:{},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e);const t=["big","huge"].includes(e.score_size)?e.score_size:"normal";this.setAttribute("data-score",t),this.showPopup=!1,this.activeMatch=null,this.showEventToasts=!0===e.show_event_toasts,this.hideHeader=!0===e.hide_header,this.hideForm=!0===e.hide_form,this.hideRecords=!0===e.hide_records,this.hideTopScorer=!0===e.hide_top_scorer,this.hideVenue=!0===e.hide_venue,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}_sportIcon(){const e=this.hass?.states?.[this._config?.entity];return{soccer:"⚽",nfl:"🏈",rugby:"🏉",nba:"🏀",nhl:"🏒",mlb:"⚾",cricket:"🏏",tennis:"🎾",mma:"🥊"}[e?.attributes?.sport||""]||"⚽"}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}connectedCallback(){super.connectedCallback(),this._subscribeToEvents(),this._clockTick=setInterval((()=>{if("undefined"!=typeof document&&"hidden"===document.visibilityState)return;const e=this.hass?.states?.[this._config?.entity],t=e?.attributes?.matches?.[0];"in"===t?.state&&t?.clock&&"N/A"!==t.clock&&this.requestUpdate()}),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._clockTick&&(clearInterval(this._clockTick),this._clockTick=null),ve("sports-live-team-popup"),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){if(!this.hass?.connection)return;this._eventSubscriptions=[];let e=!1;const t=t=>{this.hass.connection.subscribeEvents(this._handleSportsLiveEvent.bind(this),t).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)})).catch((()=>{e||(e=!0,this._setupStateChangedFallback())}))};t("sports_live_score"),t("sports_live_discipline")}_setupStateChangedFallback(){this.hass?.connection&&this.hass.connection.subscribeEvents((e=>{if(e.data.entity_id!==this._config?.entity)return;const t=e.data.new_state?.attributes?.matches?.[0],i=e.data.old_state?.attributes?.matches?.[0];if(!t||!i||"in"!==t.state)return;const a={home_team:t.home_team,away_team:t.away_team,home_score:t.home_score,away_score:t.away_score,player:"N/A",score_event_label:null};String(t.home_score)!==String(i.home_score)&&this._handleSportsLiveEvent({event_type:"sports_live_score",data:{...a,team:t.home_team}}),String(t.away_score)!==String(i.away_score)&&this._handleSportsLiveEvent({event_type:"sports_live_score",data:{...a,team:t.away_team}})}),"state_changed").then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)})).catch((()=>{}))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];if(!t)return!1;const i=t.attributes.matches||[];if(0===i.length)return!1;const a=i[0];return a.home_team===e.home_team&&a.away_team===e.away_team}_handleSportsLiveEvent(e){const t=e.event_type,i=e.data;if(this._eventBelongsToThisCard(i)&&this.showEventToasts)if("sports_live_score"===t){const e=i.team===i.home_team?"home":"away";requestAnimationFrame((()=>this._triggerGoalCelebration(e,i)))}else this._showEventToast(t,i)}_showEventToast(e,t){let i="",a="goal";if("sports_live_score"===e)i=`<strong>${(t.score_event_label||this._t("event.goal")).toUpperCase()}!</strong> ${t.player&&"N/A"!==t.player?`${t.player} · `:""}${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="goal";else if("sports_live_discipline"===e){const e=String(t.discipline_type||"").toUpperCase(),s=t.minute&&"N/A"!==t.minute?` (${t.minute}')`:"";"YELLOW"===e?(i=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${s}`,a="yellow"):"RED"===e&&(i=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${s}`,a="red")}i&&(this._toastMessage=i,this._toastVariant=a,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}_triggerGoalCelebration(e,t){const i=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!i)return;i.querySelectorAll(".confetti, .goal-banner, .goal-flash-overlay").forEach((e=>e.remove())),i.classList.remove("goal-flash"),i.offsetWidth,i.classList.add("goal-flash"),setTimeout((()=>i.classList.remove("goal-flash")),1700);const a=document.createElement("div");a.className="goal-flash-overlay",i.appendChild(a),setTimeout((()=>a.remove()),1e3);const s=document.createElement("div");s.className="goal-banner",s.innerHTML='<div class="goal-banner-text">GOAL!</div>',i.appendChild(s),setTimeout((()=>s.remove()),1700);const n=i.querySelector(".score-numbers");n&&(n.classList.remove("goal-scored"),n.offsetWidth,n.classList.add("goal-scored"),setTimeout((()=>n.classList.remove("goal-scored")),1300));const o=i.querySelectorAll(".team-side .team-logo-big"),r="away"===e?o[1]:o[0];r&&(r.classList.remove("scorer-bounce"),r.offsetWidth,r.classList.add("scorer-bounce"),setTimeout((()=>r.classList.remove("scorer-bounce")),1300)),navigator.vibrate&&navigator.vibrate([180,80,180,80,280]),setTimeout((()=>this._showEventToast("sports_live_score",t)),600);const l=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],c=["⚽","🎉","✨","🔥","⭐"];for(let e=0;e<36;e++){const e=document.createElement("div");e.className="confetti",Math.random()>.55?(e.textContent=c[Math.floor(Math.random()*c.length)],e.style.fontSize=14+10*Math.random()+"px",e.style.background="transparent"):(e.style.background=l[Math.floor(Math.random()*l.length)],e.style.borderRadius=Math.random()>.5?"50%":"2px");const t=380*(Math.random()-.5)+"px",a=240*Math.random()+100+"px";e.style.setProperty("--dx",t),e.style.setProperty("--dy",a),e.style.animationDelay=.3*Math.random()+"s",i.appendChild(e),setTimeout((()=>e.remove()),2e3)}}getCardSize(){return 4}static getConfigElement(){return document.createElement("sports-live-team-editor")}static getStubConfig(){return{entity:"",show_event_toasts:!1}}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],i=[],a=[],s=[],n=[],o=[],r=[];return e.forEach((e=>{const l=String(e||""),c=l.toLowerCase();c.startsWith("try")?s.push(this.formatMatchEvent(l)):c.startsWith("conversion")?n.push(this.formatMatchEvent(l)):c.startsWith("penalty goal")||c.startsWith("penalty - scored")?o.push(this.formatMatchEvent(l)):c.startsWith("drop goal")?r.push(this.formatMatchEvent(l)):c.includes("goal")?t.push(this.formatMatchEvent(l)):c.includes("yellow card")?i.push(this.formatMatchEvent(l)):c.includes("red card")&&a.push(this.formatMatchEvent(l))})),{goals:t,yellowCards:i,redCards:a,tries:s,conversions:n,penaltyGoals:o,dropGoals:r}}formatMatchEvent(e){const t=e=>this._t(e);let i=String(e||"").trim();i=i.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Try\s*-\s*/i,"").replace(/^Conversion\s*-\s*/i,"").replace(/^Penalty Goal\s*-\s*/i,"").replace(/^Drop Goal\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),i=i.replace(/^([^:]+):\s*/,"$1 ");const a=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return i=i.replace(new RegExp(`^(${a.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,i)=>`${i} (${t.toLowerCase()})`)),i=i.replace(/\bN\/A\b/g,t("generic.unknown")),i}_getBroadcast(e){const t=this._config?.broadcast_region||"uk",i=e.broadcast_uk&&"N/A"!==e.broadcast_uk?e.broadcast_uk:"",a=e.broadcast&&"N/A"!==e.broadcast&&""!==e.broadcast?e.broadcast:"";return"us"===t?a||i:"both"===t?[i,a].filter(Boolean).join(" / ")||"":i||a}_renderStatusBadge(e){const t=e.state;return"in"===t?U`<span class="status-badge live"><span class="dot"></span>${this._t("status.live")}</span>`:"post"===t?U`<span class="status-badge finished">${this._t("status.finished")}</span>`:U`<span class="status-badge scheduled">${e.date||this._t("status.scheduled")}</span>`}_advanceClock(e,t){const i=Math.floor((Date.now()-new Date(t).getTime())/1e3);if(i<0||i>300)return e;if(e.includes(":")){const t=e.split(":");if(2!==t.length)return e;const a=60*parseInt(t[0],10)+parseInt(t[1],10);if(isNaN(a))return e;const s=a+i;return`${Math.floor(s/60)}:${(s%60).toString().padStart(2,"0")}`}const a=e.match(/^(\d+)'$/);return a?`${parseInt(a[1],10)+Math.floor(i/60)}'`:e}_renderClock(e){const t=e.state;if("in"===t){const t=this.hass?.states?.[this._config?.entity],i=t?.last_updated,a=e.clock&&"N/A"!==e.clock?e.clock:"",s=a&&i?this._advanceClock(a,i):a,n=e.status_detail&&"N/A"!==e.status_detail?e.status_detail:"",o=s||n||e.status||"";return U`<div class="clock"><span class="dot"></span>${o}</div>`}return"post"===t?U`<div class="clock finished">${this._t("status.full_time")}</div>`:U`<div class="clock upcoming">${e.date||""}</div>`}_renderRecord(e){if(!e||"N/A"===e)return"";const t=String(e).split("-");return 3===t.length?U`<div class="record">
      ...
      </div>`:U`<div class="record"><span class="rec">${e}</span></div>`}_renderTopScorer(e){if(!e||!e.name)return"";const t=e.short_name||e.name,i=this._t("team.top_scorer");return U`
    ...
    `}_renderForm(e){if(!e||"N/A"===e)return"";const t=String(e).replace(/[^WLDwld]/g,"").toUpperCase();if(!t.length)return"";const i=t.slice(-5).split(""),a=e=>this._t("form."+e);return U`
      <div class="form-pills">
        ${i.map((e=>U`<div class="form-pill ${e}">${a(e)}</div>`))}
      </div>
    `}_renderStatsRow(e){const t=this.hass?.states?.[this._config?.entity]?.attributes?.sport||"",i=e.home_statistics||{},a=e.away_statistics||{},s=[],n=e=>{const t=parseFloat(e);return isNaN(t)?null:t},o=function(e,t,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"";const o=n(t),r=n(i);if(null===o||null===r)return;const l=o+r,c=l>0?o/l*100:50;s.push(U`
        <div class="stat-bar">
          <div class="stat-bar-label">
            <span class="home-val">${t}${a}</span>
            <span class="label-text">${e}</span>
            <span class="away-val">${i}${a}</span>
          </div>
      ...
      `)};t&&"soccer"!==t&&"rugby"!==t||(o(this._t("team.possession"),i.possessionPct,a.possessionPct,"%"),o(this._t("team.shots"),i.totalShots,a.totalShots),o(this._t("team.on_target"),i.shotsOnTarget,a.shotsOnTarget));const r=n(e.home_win_probability),l=n(e.away_win_probability);null!==r&&null!==l&&r+l>0&&s.push(U`
        <div class="stat-bar">
          <div class="stat-bar-label">
      ...
      `);const c=parseInt(e.home_timeouts,10),d=parseInt(e.away_timeouts,10);if(!isNaN(c)&&!isNaN(d)){const e=(e,t)=>Array.from({length:3},((i,a)=>U`<span class="timeout-dot ${t} ${a<e?"active":"spent"}"></span>`));s.push(U`
      ...
      `)}return 0===s.length?"":U`<div class="stats-row">${s}</div>`}render(){if(!this.hass||!this._config)return U``;const e=this._config.entity,t=this.hass.states[e];if(!t)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;if(!t.attributes.matches||0===t.attributes.matches.length)return U`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const i=t.attributes.matches[0],a="in"===i.state,s="post"===i.state,n=a||s,o=i.league_name&&"N/A"!==i.league_name?i.league_name:i.season_info&&"N/A"!==i.season_info&&this._shouldShowPhase(i.season_info)?this._translatePhase(i.season_info):"",r=i.venue&&"N/A"!==i.venue?i.venue:"",l=i.venue_city&&"N/A"!==i.venue_city?i.venue_city:"",c=r?l?`${r}, ${l}`:r:"—",d=this._getBroadcast(i),p=parseInt(i.attendance,10),h=!isNaN(p)&&p>0;return U`
      <ha-card class="${a?"live":""}">
        <div class="bg-logos">
          ${i.home_logo?U`<div class="bg-logo home"><img src="${i.home_logo}" alt="" loading="lazy"></div>`:""}
          ${i.away_logo?U`<div class="bg-logo away"><img src="${i.away_logo}" alt="" loading="lazy"></div>`:""}
        </div>
        <div class="hero-bg"></div>
        ...
        <div class="scoreboard">
          <div class="team-side home">
            <div class="team-logo-wrap">
              <img class="team-logo-big" src="${xe(i.home_logo)}" onerror="${_e}" alt="${i.home_team}" />
            </div>
            <div class="team-name-big">${i.home_team}</div>
            ${this.hideRecords?"":this._renderRecord(i.home_record)}
            ${this.hideForm?"":this._renderForm(i.home_form)}
            ${a||this.hideTopScorer?"":this._renderTopScorer(i.home_top_scorer)}
          </div>

          <div class="score-center">
            ${n?U`<div class="score-numbers">${i.home_score} <span class="dash">-</span> ${i.away_score}</div>`:U`<div class="score-vs">VS</div>`}
            ${this._renderClock(i)}
          </div>

          <div class="team-side away">
            <div class="team-logo-wrap">
              <img class="team-logo-big" src="${xe(i.away_logo)}" onerror="${_e}" alt="${i.away_team}" />
            </div>
            <div class="team-name-big">${i.away_team}</div>
            ${this.hideRecords?"":this._renderRecord(i.away_record)}
            ${this.hideForm?"":this._renderForm(i.away_form)}
            ${a||this.hideTopScorer?"":this._renderTopScorer(i.away_top_scorer)}
          </div>
        </div>
        ...
        <div class="meta-row">
          ...
          ${n?U`<button class="info-btn" @click="${()=>this.showDetails(i)}">${this._t("team.details")} ›</button>`:U`
              <div class="meta-item">
    ...
    `}render(){if(!this.hass||!this._config)return U``;const e=this.hass.states[this._config.entity];if(!e)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return U`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const i=t[0],a=i.lineup_home||e.attributes.lineup_home||[],s=i.lineup_away||e.attributes.lineup_away||[],n=i.formation_home||e.attributes.formation_home||"",o=i.formation_away||e.attributes.formation_away||"";if(0===a.length&&0===s.length)return U`
      ...
      `;const r=this._starters(a),l=this._bench(a),c=this._starters(s),d=this._bench(s);return U`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":U`
        ...
        <div class="teams-row">
          <div class="team-block">
            <div class="team-block-head">
              <img src="${xe(i.home_logo)}" onerror="${_e}" alt="${i.home_team}" />
          ...
          <div class="team-block">
            <div class="team-block-head">
              <img src="${xe(i.away_logo)}" onerror="${_e}" alt="${i.away_team}" />
              <div class="team-block-info">
    ...
    `}}),customElements.define("sports-live-timeline",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.reverseOrder=!0===e.reverse_order,this.showOnlyKey=!0===e.show_only_key,this.maxEvents=e.max_events?parseInt(e.max_events,10):0}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 5}static getConfigElement(){return document.createElement("sports-live-timeline-editor")}static getStubConfig(){return{entity:"",hide_header:!1,reverse_order:!0}}_eventMeta(e){const t=(e.type||"").toLowerCase(),i=(e.type_text||"").toLowerCase();return i.includes("kickoff")||"kickoff"===t?{icon:"⚽",label:this._t("status.kickoff"),cls:"meta"}:i.includes("halftime")||i.includes("intervallo")?{icon:"⏸",label:this._t("status.halftime"),cls:"meta"}:i.includes("start 2nd")||i.includes("secondo tempo")?{icon:"▶",label:this._t("status.second_half"),cls:"meta"}:i.includes("end regular")||i.includes("full time")?{icon:"🏁",label:this._t("status.end"),cls:"meta"}:"goal"===t||e.scoring_play?{icon:"⚽",label:this._t("event.goal"),cls:"goal"}:i.includes("penalty")?{icon:"⚽",label:this._t("timeline.penalty"),cls:"goal"}:i.includes("yellow card")?{icon:"🟨",label:this._t("event.yellow_card"),cls:"yellow"}:i.includes("red card")?{icon:"🟥",label:this._t("event.red_card"),cls:"red"}:"substitution"===t||i.includes("substitution")?{icon:"🔄",label:this._t("event.substitution"),cls:"sub"}:i.includes("var")?{icon:"📺",label:this._t("event.var"),cls:"meta"}:{icon:"·",label:e.type_text||this._t("timeline.event"),cls:"meta"}}render(){if(!this.hass||!this._config)return U``;const e=this.hass.states[this._config.entity];if(!e)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return U`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const i=t[0],a=i.key_events||e.attributes.key_events||[];if(0===a.length)return U`
      ...
      `;let s=this.reverseOrder?[...a].reverse():a;return this.showOnlyKey&&(s=s.filter((e=>{const t=(e.type||"").toLowerCase(),i=(e.type_text||"").toLowerCase();return e.scoring_play||"goal"===t||i.includes("goal")||i.includes("yellow card")||i.includes("red card")}))),this.maxEvents>0&&(s=s.slice(0,this.maxEvents)),U`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":U`
          <div class="tl-header">
            ...
            <div class="header-text">
              ...
              <div class="subtitle">
                <img class="mini-logo" src="${xe(i.home_logo)}" onerror="${_e}" alt="" />
                <span>${i.home_score??"-"} - ${i.away_score??"-"}</span>
                <img class="mini-logo" src="${xe(i.away_logo)}" onerror="${_e}" alt="" />
              </div>
            </div>
          </div>
        `}
        ...
        <div class="tl-body">
          ${s.map((e=>{const t=this._eventMeta(e),a=i.home_team&&e.team===i.home_team,s=i.away_team&&e.team===i.away_team,n=a?"home":s?"away":"meta",o=(e.athletes||[]).filter(Boolean);return U`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"sports-live-timeline",name:"Sports Live Timeline",description:"Minute-by-minute match event timeline."}),customElements.define("sports-live-timeline-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 12px; color: var(--secondary-text-color); }
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.detail.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.checked;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=parseInt(t.value,10);isNaN(a)||this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.value;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>{if(!e.startsWith("sensor."))return!1;const t=this.hass.states[e]?.attributes;return void 0!==t?.sport&&Array.isArray(t?.matches)})).sort())}render(){if(!this._config||!this.hass)return U``;const e=this._config.entity||"";return e&&this.entities.includes(e),U`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          <label class="field-label">Entity (team next_match sensor)</label>
    ...
    `}}),customElements.define("sports-live-bracket",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.compactMode=!0===e.compact,this._cardStyle="tree"===e.style?"tree":"list",this.treeShowPlayoffs=!0===e.tree_show_playoffs}_t(e,t){return pe(e,de(this.hass,this._config),t)}_formatDate(e){if(!e)return"";try{const t=new Date(e),i=this._t("month."+(t.getMonth()+1));return`${t.getDate()} ${i}`}catch(e){return""}}_localizeRoundName(e){const t={Final:"round.final",Semifinals:"round.semifinals",Quarterfinals:"round.quarterfinals","Round of 16":"round.r16","Round of 32":"round.r32","Knockout Playoffs":"round.knockout_playoffs","Preliminary Round":"round.preliminary"}[e.name];return t?this._t(t):e.name}getCardSize(){return 6}static getConfigElement(){return document.createElement("sports-live-bracket-editor")}static getStubConfig(){return{entity:"",hide_header:!1,compact:!1,style:"list"}}_formatScore(e){return null==e?"-":String(e)}_isLight(){return this._config&&"light"===this._config.skin}_showTieDetail(e){const t=e.team_a||{},i=e.team_b||{},a=e.single,s=e.leg1,n=e.leg2,o=e.winner_team,r=e.decided_on_penalties||!1,l=e.penalty_score||null,c=e.penalty_details||[],d=e=>{if(!e)return"";try{return new Date(e).toLocaleString(void 0,{weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}},p=(e,a,s)=>{if(!e)return"";const n=e.home_team===t.name?e.home_score:e.away_score,r=e.home_team===i.name?e.home_score:e.away_score,l=null!=n?n:"–",c=null!=r?r:"–",p="in"===e.state&&e.in_penalty_shootout,h="in"===e.state?`<span style="color:#ef4444;font-weight:800;">⬤ LIVE ${fe(e.clock||"")} ${p?"🎯 Penalty Shootout":fe(e.status_detail||"")}</span>`:"post"===e.state?`<span style="color:#94a3b8;font-size:11px;">${fe(e.status_detail||"Full Time")}</span>`:`<span style="color:#94a3b8;font-size:11px;">${fe(d(e.date))}</span>`,g=e.venue?`<div style="color:#94a3b8;font-size:11px;margin-top:4px;">📍 ${fe(e.venue)}</div>`:"";return`\n        <div style="margin-bottom:12px;">\n          ${a?`<div style="font-size:10px;font-weight:700;color:#6366f1;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:6px;">${fe(a)}</div>`:""}\n          <div style="display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:6px;">\n            <span style="font-weight:${o&&o===t.name?"900":"700"};font-size:15px;flex:1;text-align:right;color:${o&&o===t.name?"#10b981":"inherit"};">${o&&o===t.name?"🏆 ":""}${fe(t.name||"TBD")}</span>\n            <span style="font-size:22px;font-weight:900;font-variant-numeric:tabular-nums;letter-spacing:0.05em;background:rgba(255,255,255,0.07);padding:4px 14px;border-radius:8px;">${fe(String(l))} – ${fe(String(c))}</span>\n            <span style="font-weight:${o&&o===i.name?"900":"700"};font-size:15px;flex:1;text-align:left;color:${o&&o===i.name?"#10b981":"inherit"};">${o&&o===i.name?"🏆 ":""}${fe(i.name||"TBD")}</span>\n          </div>\n          <div style="text-align:center;">${h}</div>\n          ${g}\n        </div>`},h=o?`<div style="margin-top:14px;padding:10px 16px;background:rgba(16,185,129,0.12);border:1px solid rgba(16,185,129,0.3);border-radius:10px;text-align:center;">\n           🏆 <strong>${fe(o)}</strong> advances${r?" (on penalties)":""}\n         </div>`:"";let g=null,u=null;if(l&&o){const e=l.split("-").map(Number);2===e.length&&(g=o===t.name?e[0]:e[1],u=o===i.name?e[0]:e[1])}const f=a&&a.in_penalty_shootout||s&&s.in_penalty_shootout||n&&n.in_penalty_shootout,m=e=>{if(!e)return'<div style="display:flex;flex-direction:column;align-items:center;gap:2px;"><div style="width:22px;height:22px;border-radius:50%;background:rgba(148,163,184,0.12);border:1.5px dashed rgba(148,163,184,0.25);"></div><div style="height:9px;"></div></div>';const t=e.scored?"#10b981":"#ef4444",i=e.scored?"rgba(16,185,129,0.4)":"rgba(239,68,68,0.4)",a=e.scored?"✓":"✕",s=(e.player||"").split(" ").slice(-1)[0]||"";return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px;"><div title="${fe(e.player||"")}" style="width:22px;height:22px;border-radius:50%;background:${t};display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:900;box-shadow:0 2px 6px ${i};">${a}</div><div style="font-size:7.5px;color:#94a3b8;width:30px;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${fe(e.player||"")}">${fe(s)}</div></div>`},v=e=>{if(!r&&!f)return"";const a=e.filter((e=>e.team===t.name)),s=e.filter((e=>e.team===i.name)),n=Math.max(a.length,s.length),l=(e,t,i,a,s,o)=>{const r=n>0?Array.from({length:n},((e,t)=>a[t]||null)):[],l=o?"#10b981":"inherit";return`<div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;border-radius:10px;${o?"background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.22);":"background:rgba(255,255,255,0.03);border:1px solid transparent;"}">${i?`<img src="${fe(i)}" onerror="this.style.display='none'" style="width:26px;height:26px;object-fit:contain;flex-shrink:0;margin-top:3px;" />`:'<div style="width:26px;"></div>'}<span style="font-size:11px;font-weight:900;letter-spacing:0.04em;min-width:34px;padding-top:5px;">${fe(t||e.slice(0,3).toUpperCase())}</span>${null!=s?`<span style="font-size:17px;font-weight:900;color:${l};min-width:22px;text-align:center;padding-top:2px;">[${s}]</span>`:'<span style="min-width:22px;"></span>'}<div style="display:flex;gap:5px;flex-wrap:wrap;">${r.map(m).join("")}</div>${o?'<span style="margin-left:auto;padding-top:2px;font-size:14px;flex-shrink:0;">🏆</span>':""}</div>`};return`<div style="margin-top:12px;background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.18);border-radius:12px;padding:12px 14px;"><div style="font-size:10px;font-weight:800;color:${f?"#ef4444":"#fbbf24"};text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;${f?"animation:pulse 1s infinite;":""}">${f?"⬤ Penalty Shootout":"🎯 Penalty Shootout"}</div>${l(t.name||"",t.abbrev||"",t.logo,a,g,o===t.name)}<div style="height:5px;"></div>${l(i.name||"",i.abbrev||"",i.logo,s,u,o===i.name)}</div>`},b=v(c),x=e.aggregate?`<div style="text-align:center;font-size:12px;color:#94a3b8;margin-top:6px;">Aggregate: <strong>${fe(e.aggregate)}</strong></div>`:"",_=a&&a.note||s&&s.note||"",y=a?d(a.date):s?d(s.date):"",w=`\n      <div style="background:var(--p-bg);color:var(--p-text);border-radius:20px;padding:24px;width:min(92vw,420px);position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.5);max-height:85vh;overflow-y:auto;">\n        <button onclick="document.getElementById('sl-bracket-popup').remove()" style="position:absolute;top:14px;right:14px;background:var(--p-panel);border:none;border-radius:50%;width:30px;height:30px;font-size:18px;cursor:pointer;color:var(--p-text);display:flex;align-items:center;justify-content:center;line-height:1;">×</button>\n        ${_?`<div style="font-size:11px;font-weight:800;color:#6366f1;text-transform:uppercase;letter-spacing:0.12em;margin-bottom:12px;">${fe(_)}</div>`:""}\n        <div style="display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:18px;">\n          ${t.logo?`<img src="${fe(t.logo)}" style="width:40px;height:40px;object-fit:contain;" onerror="this.style.display='none'" />`:""}\n          <div style="text-align:center;">\n            <div style="font-size:14px;font-weight:800;">${fe(t.name||"TBD")} vs ${fe(i.name||"TBD")}</div>\n            ${y?`<div style="font-size:11px;color:var(--p-sub);margin-top:2px;">${fe(y)}</div>`:""}\n          </div>\n          ${i.logo?`<img src="${fe(i.logo)}" style="width:40px;height:40px;object-fit:contain;" onerror="this.style.display='none'" />`:""}\n        </div>\n        <div style="border-top:1px solid var(--p-border);padding-top:14px;">\n          ${a?p(a,""):p(s,"1st Leg")+p(n,"2nd Leg")}\n        </div>\n        <div id="sl-bracket-shootout-placeholder">${b}</div>\n        ${x}\n        ${h}\n      </div>`,$=me("sl-bracket-popup",this._isLight(),(()=>ve("sl-bracket-popup")));$.innerHTML=w;const k=this.hass?.states?.[this._config?.entity]?.attributes||{},C=a||s||n||{},z=r&&C.event_id&&k.competition_code&&k.sport?`https://site.api.espn.com/apis/site/v2/sports/${k.sport}/${k.competition_code}/summary?event=${C.event_id}`:null;r&&!c.length&&z&&fetch(z).then((e=>e.json())).then((e=>{const t=[];for(const i of e.shootout||[])for(const e of i.shots||[])t.push({team:i.team,player:e.player||"",scored:!!e.didScore,_n:e.shotNumber||0});t.sort(((e,t)=>e._n-t._n));const i=$.querySelector("#sl-bracket-shootout-placeholder");i&&(i.innerHTML=v(t))})).catch((()=>{}))}_renderTie(e){const t=e.team_a||{},i=e.team_b||{},a=e.leg1,s=e.leg2,n=e.single,o=e.winner_team,r=o&&t.name&&o===t.name,l=o&&i.name&&o===i.name,c=e.decided_on_penalties||!1,d=e.penalty_score||null,p=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null,h=p(a,t),g=p(a,i),u=p(s,t),f=p(s,i),m=p(n,t),v=p(n,i),b=a&&"in"===a.state||s&&"in"===s.state||n&&"in"===n.state,x=a&&a.in_penalty_shootout||s&&s.in_penalty_shootout||n&&n.in_penalty_shootout,_=!a&&!n;let y=null,w=null;if(c&&d){const e=d.split("-").map(Number);2!==e.length||isNaN(e[0])||isNaN(e[1])||(r?(y=e[0],w=e[1]):l&&(w=e[0],y=e[1]))}return U`
      <div class="tie ${b?"live":""} ${e.completed?"done":""} clickable" @click=${()=>this._showTieDetail(e)}>
        <div class="tie-row ${r?"winner":""} ${l?"loser":""}">
          <img src="${xe(t.logo)}" onerror="${_e}" alt="${t.name}" />
          <span class="tname">${t.name||"TBD"}${r&&c?U`<span class="pen-crown"> ✓</span>`:""}</span>
          <span class="legs">
            ${n?U`
              <span class="leg">${this._formatScore(m)}${null!==y?U`<span class="pen-sub">(${y}P)</span>`:""}</span>
            `:U`
        ...
        <div class="tie-row ${l?"winner":""} ${r?"loser":""}">
          <img src="${xe(i.logo)}" onerror="${_e}" alt="${i.name}" />
          <span class="tname">${i.name||"TBD"}${l&&c?U`<span class="pen-crown"> ✓</span>`:""}</span>
          <span class="legs">
            ${n?U`
              <span class="leg">${this._formatScore(v)}${null!==w?U`<span class="pen-sub">(${w}P)</span>`:""}</span>
            `:U`
              <span class="leg">${this._formatScore(g)}</span>
              <span class="leg">${this._formatScore(f)}</span>
            `}
          </span>
        </div>
        <div class="tie-foot">
          ${b?U`<span class="live-badge"><span class="dot"></span>${x?"🎯 PEN":"LIVE"}</span>`:""}
          ${c?U`<span class="agg pen-badge">🎯 PEN${d?` ${d}`:""}</span>`:""}
          ...
          ${e.completed||b||!e.first_leg_date?"":U`<span class="date">${this._formatDate(e.first_leg_date)}</span>`}
          ${_?U`<span class="date pending">${this._t("bracket.tbd")}</span>`:""}
        </div>
      </div>
    `}_aggregateFor(e,t){if(!t||!t.name)return null;const i=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null;if(e.single)return i(e.single,t);let a=0,s=!1;const n=i(e.leg1,t),o=i(e.leg2,t);return null!=n&&(a+=n,s=!0),null!=o&&(a+=o,s=!0),s?a:null}_renderMiniTie(e){const t=e.team_a||{},i=e.team_b||{},a=this._aggregateFor(e,t),s=this._aggregateFor(e,i),n=e.winner_team,o=n&&t.name&&n===t.name,r=n&&i.name&&n===i.name,l=e.leg1&&"in"===e.leg1.state||e.leg2&&"in"===e.leg2.state||e.single&&"in"===e.single.state,c=e.leg1&&e.leg1.in_penalty_shootout||e.leg2&&e.leg2.in_penalty_shootout||e.single&&e.single.in_penalty_shootout,d=!e.leg1&&!e.single,p=e.decided_on_penalties||!1,h=t.abbrev||(t.name?t.name.substring(0,3).toUpperCase():"TBD"),g=i.abbrev||(i.name?i.name.substring(0,3).toUpperCase():"TBD");return U`
      <div class="mini-tie ${l?"live":""} ${e.completed?"done":""} ${d?"pending":""} ${p?"penalties":""}" @click=${d?null:()=>this._showTieDetail(e)} style="${d?"":"cursor:pointer"}">
        <div class="mini-team ${o?"winner":""} ${r?"loser":""}">
          ${t.logo?U`<img src="${t.logo}" alt="${t.name}" />`:U`<div class="logo-ph"></div>`}
          <span class="abbr">${h}</span>
          <span class="agg-num">${null!==a?a:"-"}${o&&p?U`<span class="mini-pen-mark">P</span>`:""}</span>
        </div>
        <div class="mini-team ${r?"winner":""} ${o?"loser":""}">
          ${i.logo?U`<img src="${i.logo}" alt="${i.name}" />`:U`<div class="logo-ph"></div>`}
          <span class="abbr">${g}</span>
          <span class="agg-num">${null!==s?s:"-"}${r&&p?U`<span class="mini-pen-mark">P</span>`:""}</span>
        </div>
        ${l?U`<span class="mini-live"><span class="dot ${c?"shootout":""}"></span></span>`:""}
      </div>
    ...
    `}_renderTree(e){const t=t=>{const i=e.filter((e=>e.size===t));if(0===i.length)return null;return i.find((e=>"Knockout Playoffs"!==e.name&&"Preliminary Round"!==e.name))||i[i.length-1]},i=e.find((e=>"Knockout Playoffs"===e.name)),a=t(16),s=t(8),n=t(4),o=t(2),r=t(1),l=e=>{if(!e)return{left:[],right:[]};const t=e.ties||[],i=Math.ceil(t.length/2);return{left:t.slice(0,i),right:t.slice(i)}},c=l(a),d=l(s),p=l(n),h=l(o),g=this.treeShowPlayoffs?l(i):null,u=r?r.ties[0]:null;return U`
      <div class="tree-wrap">
        <div class="tree">
    ...
    `}}),customElements.define("sports-live-game",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 3}static getConfigElement(){return document.createElement("sports-live-game-editor")}static getStubConfig(){return{entity:""}}_openLink(e){e&&window.open(e,"_blank","noopener,noreferrer")}_toHex(e){if(!e)return null;const t=String(e).replace(/^#/,"");return/^[0-9a-fA-F]{6}$/.test(t)?`#${t}`:null}_getTeamUrl(e){const t=(e||"").match(/\/i\/teamlogos\/(\w+)\/\d+\/([^./?]+)\.png/);if(!t)return"";const[,i,a]=t;return/^\d+$/.test(a)?`https://www.espn.com/${i}/team/_/id/${a}`:`https://www.espn.com/${i}/team/_/name/${a}`}_countdown(e){if(!e)return"";const t=new Date(e)-Date.now();if(t<=0)return"";const i=Math.floor(t/1e3),a=Math.floor(i/86400),s=Math.floor(i%86400/3600),n=Math.floor(i%3600/60);return a>0?`In ${a}d ${s}h`:s>0?`In ${s}h ${n}m`:`In ${n}m`}_getBroadcast(e){const t=(this._config.broadcast_region||"uk").toLowerCase();return"us"===t?e.broadcast||"":"both"===t?[e.broadcast,e.broadcast_uk].filter(Boolean).join(" / "):e.broadcast_uk||""}_renderWinProb(e){const t=e.home_win_probability,i=e.away_win_probability;if(null==t||null==i)return"";const a=parseFloat(t).toFixed(0),s=parseFloat(i).toFixed(0);return U`
      <div class="win-prob">
        ...
        <div class="prob-track">
          <div class="prob-home" style="width:${a}%"></div>
          <div class="prob-away" style="width:${s}%"></div>
        </div>
      </div>
    `}_renderDownDistance(e){return e.down_distance_text?U`<div class="down-distance">${e.down_distance_text}</div>`:""}_renderTimeouts(e){const t=e.home_timeouts,i=e.away_timeouts;if(null==t&&null==i)return"";const a=e=>{const t=parseInt(e,10)||0;return Array.from({length:3},((e,i)=>U`
        <span class="to-dot ${i<t?"on":""}"></span>
      `))};return U`
      <div class="timeouts-row">
        <div class="to-side">${a(t)}</div>
        <span class="to-label">TO</span>
        <div class="to-side">${a(i)}</div>
      </div>
    `}_renderBaseball(e){const{balls:t,strikes:i,outs:a,on_first:s,on_second:n,on_third:o}=e;return null==t&&null==i&&null==a?"":U`
      <div class="baseball-row">
        <div class="bso">
          <div class="bso-item"><span class="bso-num">${t??"-"}</span><span class="bso-key">B</span></div>
          <div class="bso-item"><span class="bso-num">${i??"-"}</span><span class="bso-key">S</span></div>
          <div class="bso-item"><span class="bso-num">${a??"-"}</span><span class="bso-key">O</span></div>
        </div>
    ...
    `:""}_renderPeriodLabel(e){const t=e.period;if(!t||"N/A"===t)return"";const i=parseInt(t,10),a=(e.status||"").toLowerCase();if(a.includes("half")||a.includes("over")||a.includes("end"))return U`<div class="period-label">${e.status}</div>`;const s=["st","nd","rd","th"][Math.min(i-1,3)]||"th";return U`<div class="period-label">${i}${s}</div>`}_renderOdds(e){return this._config.show_odds&&(e.odds_details||null!=e.over_under)?U`
      <div class="odds-row">
        ${e.odds_details?U`<span class="odds-chip">${e.odds_details}</span>`:""}
        ${null!=e.over_under?U`<span class="odds-chip">O/U ${e.over_under}</span>`:""}
      </div>
    `:""}_showPopup(e,t,i,a){const s=this._config&&"light"===this._config.skin,n=this._getBroadcast(e),o=e.match_details||[],r="sl-game-popup",l=(e,t)=>t?`<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;padding:5px 0;border-bottom:1px solid var(--p-border);">\n           <span style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--p-sub);min-width:80px;flex-shrink:0;">${fe(e)}</span>\n           <span style="font-size:12px;color:var(--p-text);text-align:right;">${fe(String(t))}</span>\n         </div>`:"",c=o.length?`<div style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:0.08em;color:var(--p-sub);margin-top:10px;margin-bottom:4px;">Events</div>\n         ${o.slice(0,8).map((e=>`<div style="font-size:11px;color:var(--p-sub);padding:2px 0;">${fe(e)}</div>`)).join("")}`:"",d=t?`<button onclick="window.open('${fe(t)}','_blank','noopener,noreferrer');document.getElementById('${r}').remove();"\n           style="width:100%;margin-top:12px;background:linear-gradient(135deg,${fe(i)},${fe(a)});color:white;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:0.04em;padding:10px 16px;border-radius:10px;">\n           View on ESPN →\n         </button>`:"",p=`\n      <div style="background:var(--p-bg);color:var(--p-text);border-radius:20px;width:min(92vw,400px);overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.5);">\n        <div style="background:linear-gradient(135deg,${fe(i)},${fe(a)});display:flex;justify-content:space-between;align-items:center;padding:12px 16px;">\n          <span style="font-size:13px;font-weight:800;color:white;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${fe(e.home_team)} vs ${fe(e.away_team)}</span>\n          <button onclick="document.getElementById('${r}').remove();"\n            style="flex-shrink:0;background:rgba(255,255,255,0.2);border:none;cursor:pointer;color:white;font-size:18px;width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;line-height:1;margin-left:8px;">×</button>\n        </div>\n        <div style="padding:14px 16px 16px;display:flex;flex-direction:column;gap:2px;max-height:60vh;overflow-y:auto;">\n          ${l("Status",e.status_detail)}\n          ${l("Date",e.date)}\n          ${e.venue?l("Venue",e.venue+(e.venue_city?`, ${e.venue_city}`:"")):""}\n          ${e.attendance?l("Attendance",Number(e.attendance).toLocaleString()):""}\n          ${n?l("TV",n):""}\n          ${e.odds_details?l("Odds",e.odds_details):""}\n          ${null!=e.over_under?l("O/U",e.over_under):""}\n          ${null!=e.home_win_probability?l((e.home_abbrev||"Home")+" win%",parseFloat(e.home_win_probability).toFixed(0)+"%"):""}\n          ${e.home_record?l(e.home_abbrev||"Home",e.home_record):""}\n          ${e.away_record?l(e.away_abbrev||"Away",e.away_record):""}\n          ${c}\n          ${d}\n        </div>\n      </div>`;me(r,s,(()=>ve(r))).innerHTML=p}render(){if(!this.hass||!this._config)return U``;const e=this.hass.states[this._config.entity];if(!e)return U`<ha-card class="empty">Unknown entity: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(!t.length)return U`<ha-card class="empty">No match data available</ha-card>`;const i=t[0],a="in"===i.state,s="post"===i.state,n=!a&&!s,o=a||s,r=i.event_url||"",l=!1!==this._config.show_stadium,c=!1!==this._config.show_countdown,d=!1!==this._config.show_popup,p=this._toHex(i.home_color)||"#6366f1",h=this._toHex(i.away_color)||"#ec4899",g=this._getTeamUrl(i.home_logo),u=this._getTeamUrl(i.away_logo),f=this._config.score_size||"normal",m=c&&n?this._countdown(i.date_iso):"";return U`
      <ha-card
        class="${a?"live":s?"post":"pre"}"
        style="--hc: ${p}; --ac: ${h};"
        @click="${()=>{d?this._showPopup(i,r,p,h):r&&this._openLink(r)}}"
      >
        <div class="splash" aria-hidden="true"></div>
        <div class="bg-logos" aria-hidden="true">
          ${i.home_logo?U`<div class="bg-logo home"><img src="${i.home_logo}" alt="" /></div>`:""}
          ${i.away_logo?U`<div class="bg-logo away"><img src="${i.away_logo}" alt="" /></div>`:""}
        </div>

        <div class="top-bar">
          <span class="league">${i.league_name&&"N/A"!==i.league_name?i.league_name:""}</span>
          ${a?U`<span class="badge live-badge"><span class="dot"></span>LIVE</span>`:s?U`<span class="badge ft-badge">FINAL</span>`:U`<span class="badge pre-badge">${i.date||"Upcoming"}</span>`}
        </div>
        ...
        <div class="scoreboard">
          <div class="team">
            ...
            >
              <img class="logo" src="${xe(i.home_logo)}" onerror="${_e}" alt="${i.home_team}" />
            </div>
            <div class="team-name">${i.home_team}</div>
            ${i.home_record?U`<div class="record">${i.home_record}</div>`:""}
          </div>

          <div class="center">
            ${o?U`
                  <div class="score score-${f}">
                    <span>${i.home_score}</span>
                    <span class="dash">–</span>
                    <span>${i.away_score}</span>
                  </div>
                `:U`<div class="vs">VS</div>`}
            <div class="clock-row">
              ${a?U`<span class="clock clk-live"><span class="dot"></span>${i.clock&&"N/A"!==i.clock?i.clock:i.status||""}</span>`:s?U`<span class="clock clk-ft">Full Time</span>`:U`<span class="clock clk-pre">${i.date||""}</span>`}
            </div>
            ${a?this._renderPeriodLabel(i):""}
          </div>
          ...
          <div class="team">
            ...
            >
              <img class="logo" src="${xe(i.away_logo)}" onerror="${_e}" alt="${i.away_team}" />
            </div>
            <div class="team-name">${i.away_team}</div>
            ${i.away_record?U`<div class="record">${i.away_record}</div>`:""}
          </div>
        </div>

        ${n&&l&&i.venue?U`<div class="stadium">${i.venue}${i.venue_city?" · "+i.venue_city:""}</div>`:""}
        ${n&&m?U`<div class="countdown">${m}</div>`:""}
        ${n?this._renderOdds(i):""}

        ${a?this._renderDownDistance(i):""}
        ${a?this._renderTimeouts(i):""}
        ${a?this._renderBaseball(i):""}
        ${a?this._renderLastPlay(i):""}
        ${a?this._renderWinProb(i):""}

        ${s&&l&&i.venue?U`<div class="stadium">${i.venue}${i.venue_city?" · "+i.venue_city:""}</div>`:""}
