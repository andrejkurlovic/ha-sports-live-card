        ...
        <tbody>
          ${e.map((e=>{const a=this.highlightTeam&&e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam.toLowerCase());return U`
              <tr class="${this._zoneClass(e.rank,t)} clickable-row ${a?"highlighted":""}"
                ...
                <td class="team-cell">
                  <img src="${_e(e.team_logo)}" onerror="${xe}" alt="${e.team_name}" />
      ...
      <ha-card>
        ...
        <div class="scroll-content" style="max-height: ${p}px;" @scroll="${this._onUserScroll}">
          ${c.map((e=>U`
            ...
            ${e.matches.map((e=>{const t=this._matchKeyOf(e),i="in"===e.state,a=this._recentEventMatches.get(t),s=this._isWinner(e,"home"),n=this._isWinner(e,"away"),o=this._getBroadcast(e),r=this.showVenue?this._getVenue(e):"",l="pre"===e.state;return U`
        ...
        <div class="scoreboard">
          <div class="team-side home">
            <div class="team-logo-wrap">
              <img class="team-logo-big" src="${_e(i.home_logo)}" onerror="${xe}" alt="${i.home_team}" />
            </div>
          ...
          <div class="team-side away">
            <div class="team-logo-wrap">
              <img class="team-logo-big" src="${_e(i.away_logo)}" onerror="${xe}" alt="${i.away_team}" />
            </div>
        ...
        <div class="teams-row">
          <div class="team-block">
            <div class="team-block-head">
              <img src="${_e(i.home_logo)}" onerror="${xe}" alt="${i.home_team}" />
          ...
          <div class="team-block">
            <div class="team-block-head">
              <img src="${_e(i.away_logo)}" onerror="${xe}" alt="${i.away_team}" />
              <div class="team-block-info">
        ...
        ${this.hideHeader?"":U`
          <div class="tl-header">
            ...
            <div class="header-text">
              ...
              <div class="subtitle">
                <img class="mini-logo" src="${_e(i.home_logo)}" onerror="${xe}" alt="" />
                <span>${i.home_score??"-"} - ${i.away_score??"-"}</span>
                <img class="mini-logo" src="${_e(i.away_logo)}" onerror="${xe}" alt="" />
              </div>
            </div>
          </div>
        `}
    ...
    `}}),customElements.define("sports-live-bracket",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.compactMode=!0===e.compact,this._cardStyle="tree"===e.style?"tree":"list",this.treeShowPlayoffs=!0===e.tree_show_playoffs}_t(e,t){return pe(e,de(this.hass,this._config),t)}_formatDate(e){if(!e)return"";try{const t=new Date(e),i=this._t("month."+(t.getMonth()+1));return`${t.getDate()} ${i}`}catch(e){return""}}_localizeRoundName(e){const t={Final:"round.final",Semifinals:"round.semifinals",Quarterfinals:"round.quarterfinals","Round of 16":"round.r16","Round of 32":"round.r32","Knockout Playoffs":"round.knockout_playoffs","Preliminary Round":"round.preliminary"}[e.name];return t?this._t(t):e.name}getCardSize(){return 6}static getConfigElement(){return document.createElement("sports-live-bracket-editor")}static getStubConfig(){return{entity:"",hide_header:!1,compact:!1,style:"list"}}_formatScore(e){return null==e?"-":String(e)}_isLight(){return this._config&&"light"===this._config.skin}_showTieDetail(e){const t=e.team_a||{},i=e.team_b||{},a=e.single,s=e.leg1,n=e.leg2,o=e.winner_team,r=e=>{if(!e)return"";try{return new Date(e).toLocaleString(void 0,{weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}},l=(e,a,s)=>{if(!e)return"";const n=e.home_team===t.name?e.home_score:e.away_score,o=e.home_team===i.name?e.home_score:e.away_score,l=null!=n?n:"–",c=null!=o?o:"–",d="in"===e.state?`<span style="color:#ef4444;font-weight:800;">⬤ LIVE ${fe(e.clock||"")} ${fe(e.status_detail||"")}</span>`:"post"===e.state?`<span style="color:#94a3b8;font-size:11px;">${fe(e.status_detail||"Full Time")}</span>`:`<span style="color:#94a3b8;font-size:11px;">${fe(r(e.date))}</span>`,p=e.venue?`<div style="color:#94a3b8;font-size:11px;margin-top:4px;">📍 ${fe(e.venue)}</div>`:"";return`\n        <div style="margin-bottom:12px;">\n          ${a?`<div style="font-size:10px;font-weight:700;color:#6366f1;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:6px;">${fe(a)}</div>`:""}\n          <div style="display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:6px;">\n            <span style="font-weight:700;font-size:15px;flex:1;text-align:right;">${fe(t.name||"TBD")}</span>\n            <span style="font-size:22px;font-weight:900;font-variant-numeric:tabular-nums;letter-spacing:0.05em;background:rgba(255,255,255,0.07);padding:4px 14px;border-radius:8px;">${fe(String(l))} – ${fe(String(c))}</span>\n            <span style="font-weight:700;font-size:15px;flex:1;text-align:left;">${fe(i.name||"TBD")}</span>\n          </div>\n          <div style="text-align:center;">${d}</div>\n          ${p}\n        </div>`},c=o?`<div style="margin-top:14px;padding:10px 16px;background:rgba(16,185,129,0.12);border:1px solid rgba(16,185,129,0.3);border-radius:10px;text-align:center;">\n           🏆 <strong>${fe(o)}</strong> ${e.tied?"(on penalties)":"advances"}\n         </div>`:"",d=e.aggregate?`<div style="text-align:center;font-size:12px;color:#94a3b8;margin-top:6px;">Aggregate: <strong>${fe(e.aggregate)}</strong></div>`:"",p=a&&a.note||s&&s.note||"",h=a?r(a.date):s?r(s.date):"",g=`\n      <div style="background:var(--p-bg);color:var(--p-text);border-radius:20px;padding:24px;width:min(92vw,420px);position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.5);max-height:85vh;overflow-y:auto;">\n        <button onclick="document.getElementById('sl-bracket-popup').remove()" style="position:absolute;top:14px;right:14px;background:var(--p-panel);border:none;border-radius:50%;width:30px;height:30px;font-size:18px;cursor:pointer;color:var(--p-text);display:flex;align-items:center;justify-content:center;line-height:1;">×</button>\n        ${p?`<div style="font-size:11px;font-weight:800;color:#6366f1;text-transform:uppercase;letter-spacing:0.12em;margin-bottom:12px;">${fe(p)}</div>`:""}\n        <div style="display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:18px;">\n          ${t.logo?`<img src="${fe(t.logo)}" style="width:40px;height:40px;object-fit:contain;" onerror="this.style.display='none'" />`:""}\n          <div style="text-align:center;">\n            <div style="font-size:14px;font-weight:800;">${fe(t.name||"TBD")} vs ${fe(i.name||"TBD")}</div>\n            ${h?`<div style="font-size:11px;color:var(--p-sub);margin-top:2px;">${fe(h)}</div>`:""}\n          </div>\n          ${i.logo?`<img src="${fe(i.logo)}" style="width:40px;height:40px;object-fit:contain;" onerror="this.style.display='none'" />`:""}\n        </div>\n        <div style="border-top:1px solid var(--p-border);padding-top:14px;">\n          ${a?l(a,""):l(s,"1st Leg")+l(n,"2nd Leg")}\n        </div>\n        ${d}\n        ${c}\n      </div>`;me("sl-bracket-popup",this._isLight(),(()=>ve("sl-bracket-popup"))).innerHTML=g}_renderTie(e){const t=e.team_a||{},i=e.team_b||{},a=e.leg1,s=e.leg2,n=e.single,o=e.winner_team,r=o&&t.name&&o===t.name,l=o&&i.name&&o===i.name,c=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null,d=c(a,t),p=c(a,i),h=c(s,t),g=c(s,i),u=c(n,t),f=c(n,i),m=a&&"in"===a.state||s&&"in"===s.state||n&&"in"===n.state,v=!a&&!n;return U`
      <div class="tie ${m?"live":""} ${e.completed?"done":""} clickable" @click=${()=>this._showTieDetail(e)}>
        ...
        <div class="tie-row ${l?"winner":""} ${r?"loser":""}">
          <img src="${_e(i.logo)}" onerror="${xe}" alt="${i.name}" />
      ...
      >
        ...
        <div class="scoreboard">
          <div class="team">
            ...
            >
              <img class="logo" src="${_e(i.home_logo)}" onerror="${xe}" alt="${i.home_team}" />
            </div>
          ...
          <div class="team">
            ...
            >
              <img class="logo" src="${_e(i.away_logo)}" onerror="${xe}" alt="${i.away_team}" />
            </div>
