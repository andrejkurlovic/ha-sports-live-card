      ...
      <div class="card-config">
        ...
        <div>
          ...
          <select @change=${this._entityChanged}>
            ${t?"":I`<option value="${e}" selected>${e||"— seleziona —"}</option>`}
