      ...
      <ha-card>
        ...
        <div class="scroll-content" style="max-height: ${c}px;">
          ${r.map((e=>R`
            ...
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,a="in"===e.state,i=this._recentEventMatches.get(t),s=this._isWinner(e,"home"),n=this._isWinner(e,"away"),o=this._getBroadcast(e),r=this.showVenue?this._getVenue(e):"",l="pre"===e.state;return R`
