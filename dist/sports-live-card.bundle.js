...
`;function ge(e){return"light"===(e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark")?"light":"dark"}function ue(e,t){const a=ge(t);return e&&e.setAttribute&&e.setAttribute("data-skin",a),a}const fe=(e,t)=>Array.from({length:t-e+1},((t,a)=>e+a)),me={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:fe(1,8),europa:fe(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:fe(1,8),europa:fe(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:fe(1,8),europa:fe(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("sports-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},showPopup:{type:Boolean},activeTeam:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.compact=!0===e.compact,this.highlightTeam=e.highlight_team||"",this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null,this.showPopup=!1,this.activeTeam=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["sports_live_score","sports_live_discipline","sports_live_match_finished"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",a=e.competition_code;if(!a)return!1;const i=a.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(i)}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;this._eventBelongsToThisCard(a)&&this.showEventToasts&&this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";const s=t.minute&&"N/A"!==t.minute?` (${t.minute}')`:"";if("sports_live_score"===e)a=`<strong>${(t.score_event_label||this._t("event.goal")).toUpperCase()}!</strong> ${t.player&&"N/A"!==t.player?`${t.player} · `:""}${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal";else if("sports_live_discipline"===e){const e=String(t.discipline_type||"").toUpperCase();"YELLOW"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${s}`,i="yellow"):"RED"===e&&(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${s}`,i="red")}else"sports_live_match_finished"===e&&(a=`<strong>${this._t("status.full_time")}</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="finished");a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}showTeamDetails(e){this.activeTeam=e,this.showPopup=!0}updated(e){(e.has("showPopup")||e.has("activeTeam"))&&this._renderTeamPopupToBody()}_renderTeamPopupToBody(){if(!this.showPopup||!this.activeTeam){const e=document.getElementById("sports-live-standings-popup");return void(e&&e.remove())}let e=document.getElementById("sports-live-standings-popup");e||(e=document.createElement("div"),e.id="sports-live-standings-popup",e.style.cssText="\n        position:fixed; inset:0;\n        display:flex; justify-content:center; align-items:center;\n        z-index:999999;\n        background:rgba(0,0,0,0.7);\n        backdrop-filter:blur(8px);\n        overflow:auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeTeam,a=e=>this._t(e),i=e=>{const t=parseInt(String(e??"").replace("+",""),10);return isNaN(t)?null:t},s=i(t.wins),n=i(t.draws),o=i(t.losses),r=null!==s&&null!==n&&null!==o?s+n+o:null,l=i(t.goal_difference),c=null===l?"—":l>0?`+${l}`:`${l}`,d=null===l?"#94a3b8":l>0?"#10b981":l<0?"#ef4444":"#94a3b8",p=function(e,t){return`<div style="background:rgba(255,255,255,0.04);padding:12px 8px;border-radius:12px;text-align:center;">\n        <div style="font-size:18px;font-weight:900;color:${arguments.length>2&&void 0!==arguments[2]?arguments[2]:"#f8fafc"};font-variant-numeric:tabular-nums;">${t??"—"}</div>\n        <div style="font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:#94a3b8;margin-top:3px;">${e}</div>\n      </div>`},h=String(t.form||"").replace(/[^WLDwld]/g,"").toUpperCase().slice(-5),g={W:"#10b981",L:"#ef4444",D:"#f59e0b"},u=h?h.split("").map((e=>`<div style="width:22px;height:22px;border-radius:6px;background:${g[e]||"#475569"};color:white;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:800;">${e}</div>`)).join(""):"";e.innerHTML=`\n      <div style="background:#1a1f2e;padding:24px;border-radius:20px;width:90%;max-width:480px;max-height:85vh;overflow-y:auto;border:1px solid rgba(255,255,255,0.08);box-shadow:0 24px 64px rgba(0,0,0,0.6);margin:auto;color:#f8fafc;font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;">\n          ${t.team_logo?`<img src="${t.team_logo}" style="width:64px;height:64px;object-fit:contain;filter:drop-shadow(0 4px 12px rgba(0,0,0,0.4));" />`:""}\n          <div>\n            <div style="font-size:20px;font-weight:900;letter-spacing:-0.02em;">${t.team_name}</div>\n            <div style="font-size:11px;font-weight:700;color:#94a3b8;margin-top:4px;">${a("col.pos")} #${t.rank} · ${t.points??"—"} ${a("col.points")}</div>\n          </div>\n        </div>\n\n        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:18px;">\n          ${p(a("col.played"),r)}\n          ${p(a("col.wins"),s,"#10b981")}\n          ${p(a("col.draws"),n,"#f59e0b")}\n          ${p(a("col.losses"),o,"#ef4444")}\n        </div>\n        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:18px;">\n          ${p(a("col.gf"),i(t.goals_for)??(null!==i(t.points)?"—":null))}\n          ${p(a("col.ga"),i(t.goals_against)??null)}\n          ${p(a("col.gd"),c,d)}\n        </div>\n\n        ${u?`\n        <div style="margin-bottom:18px;padding:14px;background:rgba(255,255,255,0.04);border-radius:12px;">\n          <div style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:#94a3b8;margin-bottom:8px;">${a("team.form")} (${a("team.last5")})</div>\n          <div style="display:flex;gap:6px;">${u}</div>\n        </div>`:""}\n\n        <button id="standings-popup-close" style="background:linear-gradient(135deg,#6366f1,#ec4899);color:white;padding:12px 20px;border:none;border-radius:12px;cursor:pointer;margin-top:4px;font-weight:800;width:100%;font-size:14px;">${a("generic.close")}</button>\n      </div>`,e.querySelector("#standings-popup-close").addEventListener("click",(()=>{this.showPopup=!1}))}getCardSize(){return 5}static getConfigElement(){return document.createElement("sports-live-classifica-editor")}static getStubConfig(){return{entity:"",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&me[this._config.zone_preset])return me[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,a=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(me))if(t.match&&t.match(a,e))return t;return null}_positionInZone(e,t,a){if(!a)return!1;const i=String(a).match(/^bottom(\d+)$/);if(i){const a=parseInt(i[1],10);return t&&e>t-a}return!!Array.isArray(a)&&a.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const a=this._getZoneConfig();return this._positionInZone(e,t,a.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,a.europa)?"zone-el":this._positionInZone(e,t,a.conference)?"zone-conf":this._positionInZone(e,t,a.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let a=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(a=a.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),a.forEach(((e,t)=>{e.rank=t+1}))):a=a.slice().sort(((e,t)=>e.rank-t.rank)),a}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return R``;const e=this._config.entity,t=this.hass.states[e];if(!t)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const a=t.attributes.season||"",i=t.attributes.standings_groups||[],s=!this.selectedGroup&&i.length>1,n=this._currentGroup(i),o=this._sortStandings(n?n.standings:[],a),r=o.length,l=48*Math.min(this.maxTeamsVisible,r)+50;return R`
      <ha-card>
        ...
        ${this.hideHeader?"":this._renderHeader(t,a,n,i,s)}

        ${s?this._renderGroupsGrid(i,a):R`
            <div class="table-wrap" style="max-height: ${l}px;">
              ${this.compact?this._renderCompactTable(o,r):this._renderFullTable(o,r)}
            </div>
          `}

        ${this._renderLegend()}
      </ha-card>
    `}_renderFullTable(e,t){return R`
      <table class="standings-table">
        ...
        <tbody>
          ${e.map((e=>{const a=e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t},i=a(e.wins),s=a(e.draws),n=a(e.losses),o=a(e.goal_difference),r=null!==i&&null!==s&&null!==n?i+s+n:null,l=null===o?"":o>0?"gd-pos":o<0?"gd-neg":"",c=null===o?"-":o>0?`+${o}`:`${o}`,d=this.highlightTeam&&e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam.toLowerCase());return R`
              <tr class="${this._zoneClass(e.rank,t)} clickable-row ${d?"highlighted":""}"
    ...
    `}_renderCompactTable(e,t){return R`
      <table class="standings-table compact">
        ...
        <tbody>
          ${e.map((e=>{const a=(e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t})(e.goal_difference),i=null===a?"":a>0?"gd-pos":a<0?"gd-neg":"",s=null===a?"-":a>0?`+${a}`:`${a}`;return R`
    ...
    `}_renderHeader(e,t,a,i,s){const n=this._getZoneConfig(),o=this._isCupGroupStage(),r=n&&n.hero?n.hero:null,l=s?this._t("phase.group_stage"):this._shouldShowPhase(a&&a.name)?this._translatePhase(a.name):"",c=[];t&&"n/a"!==t.toLowerCase()&&c.push(t),l&&c.push(l);let d=0;if(s)for(const e of i)d+=(e.standings||[]).filter((e=>null!=e.rank)).length;return R`
      <div class="top-bar ${o?"top-bar-cup":""} ${r?`accent-${r.accent}`:""}">
        ${r&&r.icon?R`<div class="hero-icon">${r.icon}</div>`:""}
        <h2>${e.state}</h2>
      ...
      <ha-card>
        ...
        ${this.hideHeader?"":R`
          <div class="matches-header">
            ${i&&i.logo_href?R`<img class="league-logo" src="${i.logo_href}" alt="${i.abbreviation||""}" />`:s?R`<img class="league-logo" src="${s}" alt="" />`:""}
            <div class="league-info">
              <div class="league-name">${i&&i.abbreviation||t.state||"Calcio Live"}</div>
        ...
        <div class="scroll-content" style="max-height: ${c}px;">
          ${r.map((e=>R`
            ...
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,a="in"===e.state,i=this._recentEventMatches.get(t),s=this._isWinner(e,"home"),n=this._isWinner(e,"away"),o=this._getBroadcast(e),r="pre"===e.state;return R`
    ...
    `}}),customElements.define("sports-live-team",class extends oe{static get properties(){return{hass:{},_config:{},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e);const t=["big","huge"].includes(e.score_size)?e.score_size:"normal";this.setAttribute("data-score",t),this.showPopup=!1,this.activeMatch=null,this.showEventToasts=!0===e.show_event_toasts,this.hideHeader=!0===e.hide_header,this.hideForm=!0===e.hide_form,this.hideRecords=!0===e.hide_records,this.hideTopScorer=!0===e.hide_top_scorer,this.hideVenue=!0===e.hide_venue,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}_sportIcon(){const e=this.hass?.states?.[this._config?.entity];return{soccer:"⚽",nfl:"🏈",rugby:"🏉",nba:"🏀",nhl:"🏒",mlb:"⚾",cricket:"🏏",tennis:"🎾",mma:"🥊"}[e?.attributes?.sport||""]||"⚽"}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}connectedCallback(){super.connectedCallback(),this._subscribeToEvents(),this._clockTick=setInterval((()=>{const e=this.hass?.states?.[this._config?.entity],t=e?.attributes?.matches?.[0];"in"===t?.state&&t?.clock&&"N/A"!==t.clock&&this.requestUpdate()}),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._clockTick&&(clearInterval(this._clockTick),this._clockTick=null),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["sports_live_score","sports_live_discipline"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];if(!t)return!1;const a=t.attributes.matches||[];if(0===a.length)return!1;const i=a[0];return i.home_team===e.home_team&&i.away_team===e.away_team}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;if(this._eventBelongsToThisCard(a)&&this.showEventToasts)if("sports_live_score"===t){const e=a.team===a.home_team?"home":"away";requestAnimationFrame((()=>this._triggerGoalCelebration(e,a)))}else this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";if("sports_live_score"===e)a=`<strong>${(t.score_event_label||this._t("event.goal")).toUpperCase()}!</strong> ${t.player&&"N/A"!==t.player?`${t.player} · `:""}${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal";else if("sports_live_discipline"===e){const e=String(t.discipline_type||"").toUpperCase(),s=t.minute&&"N/A"!==t.minute?` (${t.minute}')`:"";"YELLOW"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${s}`,i="yellow"):"RED"===e&&(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${s}`,i="red")}a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}_triggerGoalCelebration(e,t){const a=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!a)return;a.querySelectorAll(".confetti, .goal-banner, .goal-flash-overlay").forEach((e=>e.remove())),a.classList.remove("goal-flash"),a.offsetWidth,a.classList.add("goal-flash"),setTimeout((()=>a.classList.remove("goal-flash")),1700);const i=document.createElement("div");i.className="goal-flash-overlay",a.appendChild(i),setTimeout((()=>i.remove()),1e3);const s=document.createElement("div");s.className="goal-banner",s.innerHTML='<div class="goal-banner-text">GOAL!</div>',a.appendChild(s),setTimeout((()=>s.remove()),1700);const n=a.querySelector(".score-numbers");n&&(n.classList.remove("goal-scored"),n.offsetWidth,n.classList.add("goal-scored"),setTimeout((()=>n.classList.remove("goal-scored")),1300));const o=a.querySelectorAll(".team-side .team-logo-big"),r="away"===e?o[1]:o[0];r&&(r.classList.remove("scorer-bounce"),r.offsetWidth,r.classList.add("scorer-bounce"),setTimeout((()=>r.classList.remove("scorer-bounce")),1300)),navigator.vibrate&&navigator.vibrate([180,80,180,80,280]),setTimeout((()=>this._showEventToast("sports_live_score",t)),600);const l=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],c=["⚽","🎉","✨","🔥","⭐"];for(let e=0;e<36;e++){const e=document.createElement("div");e.className="confetti",Math.random()>.55?(e.textContent=c[Math.floor(Math.random()*c.length)],e.style.fontSize=14+10*Math.random()+"px",e.style.background="transparent"):(e.style.background=l[Math.floor(Math.random()*l.length)],e.style.borderRadius=Math.random()>.5?"50%":"2px");const t=380*(Math.random()-.5)+"px",i=240*Math.random()+100+"px";e.style.setProperty("--dx",t),e.style.setProperty("--dy",i),e.style.animationDelay=.3*Math.random()+"s",a.appendChild(e),setTimeout((()=>e.remove()),2e3)}}getCardSize(){return 4}static getConfigElement(){return document.createElement("sports-live-team-editor")}static getStubConfig(){return{entity:"",show_event_toasts:!1}}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],a=[],i=[],s=[],n=[],o=[],r=[];return e.forEach((e=>{const l=String(e||""),c=l.toLowerCase();c.startsWith("try")?s.push(this.formatMatchEvent(l)):c.startsWith("conversion")?n.push(this.formatMatchEvent(l)):c.startsWith("penalty goal")||c.startsWith("penalty - scored")?o.push(this.formatMatchEvent(l)):c.startsWith("drop goal")?r.push(this.formatMatchEvent(l)):c.includes("goal")?t.push(this.formatMatchEvent(l)):c.includes("yellow card")?a.push(this.formatMatchEvent(l)):c.includes("red card")&&i.push(this.formatMatchEvent(l))})),{goals:t,yellowCards:a,redCards:i,tries:s,conversions:n,penaltyGoals:o,dropGoals:r}}formatMatchEvent(e){const t=e=>this._t(e);let a=String(e||"").trim();a=a.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Try\s*-\s*/i,"").replace(/^Conversion\s*-\s*/i,"").replace(/^Penalty Goal\s*-\s*/i,"").replace(/^Drop Goal\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),a=a.replace(/^([^:]+):\s*/,"$1 ");const i=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return a=a.replace(new RegExp(`^(${i.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,a)=>`${a} (${t.toLowerCase()})`)),a=a.replace(/\bN\/A\b/g,t("generic.unknown")),a}_getBroadcast(e){const t=this._config?.broadcast_region||"uk",a=e.broadcast_uk&&"N/A"!==e.broadcast_uk?e.broadcast_uk:"",i=e.broadcast&&"N/A"!==e.broadcast&&""!==e.broadcast?e.broadcast:"";return"us"===t?i||a:"both"===t?[a,i].filter(Boolean).join(" / ")||"":a||i}_renderStatusBadge(e){const t=e.state;return"in"===t?R`<span class="status-badge live"><span class="dot"></span>${this._t("status.live")}</span>`:"post"===t?R`<span class="status-badge finished">${this._t("status.finished")}</span>`:R`<span class="status-badge scheduled">${e.date||this._t("status.scheduled")}</span>`}_advanceClock(e,t){const a=Math.floor((Date.now()-new Date(t).getTime())/1e3);if(a<0||a>300)return e;if(e.includes(":")){const t=e.split(":");if(2!==t.length)return e;const i=60*parseInt(t[0],10)+parseInt(t[1],10);if(isNaN(i))return e;const s=i+a;return`${Math.floor(s/60)}:${(s%60).toString().padStart(2,"0")}`}const i=e.match(/^(\d+)'$/);return i?`${parseInt(i[1],10)+Math.floor(a/60)}'`:e}_renderClock(e){const t=e.state;if("in"===t){const t=this.hass?.states?.[this._config?.entity],a=t?.last_updated,i=e.clock&&"N/A"!==e.clock?e.clock:"",s=i&&a?this._advanceClock(i,a):i,n=e.status_detail&&"N/A"!==e.status_detail?e.status_detail:"",o=s||n||e.status||"";return R`<div class="clock"><span class="dot"></span>${o}</div>`}return"post"===t?R`<div class="clock finished">${this._t("status.full_time")}</div>`:R`<div class="clock upcoming">${e.date||""}</div>`}_renderRecord(e){if(!e||"N/A"===e)return"";const t=String(e).split("-");return 3===t.length?R`<div class="record">
      ...
      </div>`:R`<div class="record"><span class="rec">${e}</span></div>`}_renderTopScorer(e){if(!e||!e.name)return"";const t=e.short_name||e.name,a=this._t("team.top_scorer");return R`
    ...
    `}_renderStatsRow(e){const t=e.home_statistics||{},a=e.away_statistics||{},i=[],s=e=>{const t=parseFloat(e);return isNaN(t)?null:t},n=function(e,n,o){let r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"";const l=s(t[n]),c=s(a[o]);null!==l&&null!==c&&i.push({label:e,home:t[n],away:a[o],hNum:l,aNum:c,suffix:r})};return n(this._t("team.possession"),"possessionPct","possessionPct","%"),n(this._t("team.shots"),"totalShots","totalShots"),n(this._t("team.on_target"),"shotsOnTarget","shotsOnTarget"),0===i.length?"":R`
      <div class="stats-row">
    ...
    `}render(){if(!this.hass||!this._config)return R``;const e=this._config.entity,t=this.hass.states[e];if(!t)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;if(!t.attributes.matches||0===t.attributes.matches.length)return R`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t.attributes.matches[0],i="in"===a.state,s="post"===a.state,n=i||s,o=a.league_name&&"N/A"!==a.league_name?a.league_name:a.season_info&&"N/A"!==a.season_info&&this._shouldShowPhase(a.season_info)?this._translatePhase(a.season_info):"",r=a.venue&&"N/A"!==a.venue?a.venue:"",l=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",c=r?l?`${r}, ${l}`:r:"—",d=this._getBroadcast(a),p=parseInt(a.attendance,10),h=!isNaN(p)&&p>0;return R`
      <ha-card class="${i?"live":""}">
        ...
        ${this.hideHeader?"":R`<div class="top-bar">
        ...
        <div class="scoreboard">
          ...
          <div class="score-center">
            ${n?R`<div class="score-numbers">${a.home_score} <span class="dash">-</span> ${a.away_score}</div>`:R`<div class="score-vs">VS</div>`}
            ${this._renderClock(a)}
          </div>
        ...
        <div class="meta-row">
          ${this.hideVenue?"":R`<div class="meta-item venue-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
            <span>${c}</span>
          </div>`}
          ${n?R`<button class="info-btn" @click="${()=>this.showDetails(a)}">${this._t("team.details")} ›</button>`:R`
              <div class="meta-item">
    ...
    `}updated(e){(e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody()}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("sports-live-team-popup");return void(e&&e.remove())}let e=document.getElementById("sports-live-team-popup");e||(e=document.createElement("div"),e.id="sports-live-team-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,a=e=>this._t(e),i="light"===ge(this._config);e.style.setProperty("--p-bg",i?"#ffffff":"#1a1f2e"),e.style.setProperty("--p-panel",i?"rgba(15,23,42,0.05)":"rgba(255,255,255,0.04)"),e.style.setProperty("--p-text",i?"#14182a":"#f8fafc"),e.style.setProperty("--p-sub",i?"#5b6577":"#94a3b8"),e.style.setProperty("--p-border",i?"rgba(15,23,42,0.10)":"rgba(255,255,255,0.08)");const s=t.home_statistics||{},n=(e,t)=>`\n      <div style="background:var(--p-panel); padding:14px; border-radius:14px;">\n        <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:var(--p-sub); font-weight:700; margin-bottom:6px;">${e}</div>\n        <div style="font-size:13px;"><span style="color:var(--p-sub);">${a("team.possession")}:</span> <strong>${t?.possessionPct??"—"}%</strong></div>\n        <div style="font-size:13px;"><span style="color:var(--p-sub);">${a("team.shots")}:</span> <strong>${t?.totalShots??"—"}</strong></div>\n        <div style="font-size:13px;"><span style="color:var(--p-sub);">${a("team.on_target")}:</span> <strong>${t?.shotsOnTarget??"—"}</strong></div>\n        <div style="font-size:13px;"><span style="color:var(--p-sub);">${a("team.fouls")}:</span> <strong>${t?.foulsCommitted??"—"}</strong></div>\n      </div>`,o=null!=s.possessionPct||null!=s.totalShots||null!=s.shotsOnTarget?`\n        <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-bottom:18px;">\n          ${n(t.home_team,t.home_statistics)}\n          ${n(t.away_team,t.away_statistics)}\n        </div>`:"";e.innerHTML=`\n      <div style="background: var(--p-bg); padding: 24px; border-radius: 20px; width: 90%; max-width: 560px; max-height: 85vh; overflow-y: auto; border: 1px solid var(--p-border); box-shadow: 0 24px 64px rgba(0,0,0,0.6); margin: auto; color: var(--p-text); font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif;">\n        <h3 style="margin:0 0 20px; font-size: 22px; font-weight: 800; letter-spacing:-0.02em; background: linear-gradient(135deg,#6366f1,#ec4899); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color: transparent;">${a("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${t.home_logo}" alt="${t.home_team}" />\n          <div style="text-align:center;">\n            <div style="font-size:42px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${t.home_score??"-"} <span style="opacity:0.4;">-</span> ${t.away_score??"-"}</div>\n            <div style="font-size:12px; color:var(--p-sub); margin-top:8px; font-weight:600;">${t.clock??t.status??""}</div>\n          </div>\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${t.away_logo}" alt="${t.away_team}" />\n        </div>\n        ${o}\n        <div id="team-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,#6366f1,#ec4899); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${a("generic.close")}</button>\n      </div>\n    `;const r=e.querySelector("#popup-close-btn");r&&r.addEventListener("click",(()=>{this.showPopup=!1}));const l=e.querySelector("#team-events-container"),{goals:c,yellowCards:d,redCards:p,tries:h,conversions:g,penaltyGoals:u,dropGoals:f}=this.separateEvents(t.match_details||[]),m=(e,t,a)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${a.bg}; border-left:3px solid ${a.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${a.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:var(--p-text);">${t.map((e=>`<li style="margin:4px 0;">${e}</li>`)).join("")}</ul>\n      </div>`:"";let v="";v+=m(a("event.goal"),c,{bg:"rgba(99,102,241,0.1)",border:"#6366f1"}),v+=m(a("event.yellow_card"),d,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),v+=m(a("event.red_card"),p,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"}),v+=m(a("event.try"),h,{bg:"rgba(16,185,129,0.1)",border:"#10b981"}),v+=m(a("event.conversion"),g,{bg:"rgba(16,185,129,0.07)",border:"#34d399"}),v+=m(a("event.penalty_goal"),u,{bg:"rgba(251,191,36,0.1)",border:"#fbbf24"}),v+=m(a("event.drop_goal"),f,{bg:"rgba(99,102,241,0.07)",border:"#818cf8"});const b=t.scoring_plays||[];if(b.length){const e=b.slice().reverse().slice(0,12).map((e=>`\n        <li style="display:grid; grid-template-columns:auto 1fr auto; gap:10px; align-items:start; padding:5px 0; border-bottom:1px solid var(--p-border); font-size:12px;">\n          <span style="font-weight:700; color:var(--p-sub); font-variant-numeric:tabular-nums; white-space:nowrap;">${[e.period,e.clock].filter(Boolean).join(" ")}</span>\n          <span style="color:var(--p-text);">${e.text||""}</span>\n          <span style="font-weight:800; color:var(--p-text); white-space:nowrap; font-variant-numeric:tabular-nums;">${e.home_score??""}-${e.away_score??""}</span>\n        </li>`)).join("");v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(99,102,241,0.1); border-left:3px solid #6366f1; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#818cf8; font-weight:800;">${a("popup.scoring_plays")}</h5>\n        <ul style="margin:0; padding:0; list-style:none;">${e}</ul>\n      </div>`}const x=t.stat_leaders||[];if(x.length){const e=e=>`\n        <div style="flex:1; min-width:0;">\n          <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.08em; color:var(--p-sub); font-weight:800; margin-bottom:6px;">${e.team_name||""}</div>\n          ${(e.categories||[]).slice(0,4).map((e=>`<div style="font-size:12px; color:var(--p-text); margin:3px 0;"><span style="color:var(--p-sub);">${e.display_name}:</span> ${e.short_name||e.athlete} <strong>${e.value}</strong></div>`)).join("")}\n        </div>`;v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(251,191,36,0.08); border-left:3px solid #fbbf24; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#fbbf24; font-weight:800;">${a("popup.stat_leaders")}</h5>\n        <div style="display:flex; gap:16px;">${x.slice(0,2).map(e).join("")}</div>\n      </div>`}const _=t.lineup_home||[],y=t.lineup_away||[];if(_.length||y.length){const e=t.formation_home||"",i=t.formation_away||"",s=(e,t,a)=>{const i=(e||[]).filter((e=>e.starter));return i.length?`<div style="margin-bottom:8px;">\n          <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:6px;">\n            <span style="font-size:12px; font-weight:800; color:var(--p-text);">${a}</span>\n            ${t?`<span style="font-size:10px; font-weight:700; color:#6366f1; letter-spacing:0.1em;">${t}</span>`:""}\n          </div>\n          <div style="font-size:12px; color:var(--p-text); line-height:1.7;">\n            ${i.map((e=>`<span style="display:inline-block; padding:2px 8px; background:var(--p-panel); border-radius:6px; margin:2px;">${e.jersey?`<strong style="color:#fbbf24;">${e.jersey}</strong> `:""}${e.short_name||e.name}</span>`)).join("")}\n          </div>\n        </div>`:""};v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(16,185,129,0.08); border-left:3px solid #10b981; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#10b981; font-weight:800;">${a("popup.lineups")}</h5>\n        ${s(_,e,t.home_team)}\n        ${s(y,i,t.away_team)}\n      </div>`}const w=t.key_events||[];if(w.length){const e=e=>{const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return"goal"===t||e.scoring_play?"⚽":a.includes("yellow")?"🟨":a.includes("red")?"🟥":"substitution"===t?"🔄":a.includes("halftime")?"⏸":a.includes("kickoff")?"▶":a.includes("end")?"🏁":"·"};v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(251,191,36,0.08); border-left:3px solid #fbbf24; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#fbbf24; font-weight:800;">${a("popup.timeline")}</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${w.map((t=>`<li style="display:grid; grid-template-columns:36px 24px 1fr; gap:8px; align-items:start; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:var(--p-text);">\n            <span style="text-align:right; font-weight:700; color:var(--p-sub); font-variant-numeric:tabular-nums;">${t.clock||""}</span>\n            <span style="text-align:center;">${e(t)}</span>\n            <span><strong style="color:var(--p-text);">${(t.athletes||[]).filter(Boolean).join(", ")||t.type_text||""}</strong>${t.team?`<br><span style="color:var(--p-sub); font-size:11px;">${t.team}</span>`:""}</span>\n          </li>`)).join("")}\n        </ul>\n      </div>`}const $=t.head_to_head||[];$.length&&(v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(99,102,241,0.08); border-left:3px solid #6366f1; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6366f1; font-weight:800;">${a("popup.h2h")} (${$.length})</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${$.slice(0,8).map((e=>{const t=e.date?new Date(e.date).toLocaleDateString(de(this.hass,this._config)):"";return`<li style="display:flex; justify-content:space-between; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:var(--p-text);">\n              <span>${e.home_team} <strong>${e.home_score??"-"}</strong> - <strong>${e.away_score??"-"}</strong> ${e.away_team}</span>\n              <span style="color:var(--p-sub);">${t}</span>\n            </li>`})).join("")}\n        </ul>\n      </div>`),l.innerHTML=v||`<p style="text-align:center; color:var(--p-sub); font-size:13px;">${a("popup.no_events")}</p>`}static get styles(){return[he,n`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
          ...
          ${t.map((e=>R`
            <article class="news-item ${this.hideImages||!e.image?"no-img":""}" @click="${()=>this._openLink(e.link)}">
              ...
              <div class="news-body">
                ...
                ${!this.hideDescription&&e.description?R`<div class="news-desc">${e.description}</div>`:""}
              </div>
            </article>
          `))}
        </div>
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=parseInt(t.value,10);isNaN(i)||this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>{if(!e.startsWith("sensor."))return!1;const t=this.hass.states[e]?.attributes;return void 0!==t?.sport&&Array.isArray(t?.articles)})).sort())}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}}),customElements.define("sports-live-lineup",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.showBench=!1!==e.show_bench,this.showPhotos=!1!==e.show_photos}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 6}static getConfigElement(){return document.createElement("sports-live-lineup-editor")}static getStubConfig(){return{entity:"",hide_header:!1}}_starters(e){return(e||[]).filter((e=>!0===e.starter))}_bench(e){return(e||[]).filter((e=>!e.starter))}_renderPlayer(e){const t=(e.short_name||e.name||"").split(" ").map((e=>e[0])).slice(0,2).join("");return R`
      <div class="player" title="${e.name}">
        <div class="player-card">
          ${this.showPhotos&&e.headshot?R`<img class="player-img" src="${e.headshot}" alt="${e.name}" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';" />
    ...
    `}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return R`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.lineup_home||e.attributes.lineup_home||[],s=a.lineup_away||e.attributes.lineup_away||[],n=a.formation_home||e.attributes.formation_home||"",o=a.formation_away||e.attributes.formation_away||"";if(0===i.length&&0===s.length)return R`
      ...
      `;const r=this._starters(i),l=this._bench(i),c=this._starters(s),d=this._bench(s);return R`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":R`
          ...
          <div class="team-block">
            <div class="team-block-head">
              ...
              <div class="team-block-info">
                ...
                ${n?R`<div class="formation">${n}</div>`:""}
              </div>
            </div>
            <div class="players-grid">
              ${r.map((e=>this._renderPlayer(e)))}
            </div>
            ${this.showBench&&l.length?R`
    ...
    `}}),customElements.define("sports-live-timeline",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.reverseOrder=!0===e.reverse_order,this.showOnlyKey=!0===e.show_only_key,this.maxEvents=e.max_events?parseInt(e.max_events,10):0}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 5}static getConfigElement(){return document.createElement("sports-live-timeline-editor")}static getStubConfig(){return{entity:"",hide_header:!1,reverse_order:!0}}_eventMeta(e){const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return a.includes("kickoff")||"kickoff"===t?{icon:"⚽",label:this._t("status.kickoff"),cls:"meta"}:a.includes("halftime")||a.includes("intervallo")?{icon:"⏸",label:this._t("status.halftime"),cls:"meta"}:a.includes("start 2nd")||a.includes("secondo tempo")?{icon:"▶",label:this._t("status.second_half"),cls:"meta"}:a.includes("end regular")||a.includes("full time")?{icon:"🏁",label:this._t("status.end"),cls:"meta"}:"goal"===t||e.scoring_play?{icon:"⚽",label:this._t("event.goal"),cls:"goal"}:a.includes("penalty")?{icon:"⚽",label:this._t("timeline.penalty"),cls:"goal"}:a.includes("yellow card")?{icon:"🟨",label:this._t("event.yellow_card"),cls:"yellow"}:a.includes("red card")?{icon:"🟥",label:this._t("event.red_card"),cls:"red"}:"substitution"===t||a.includes("substitution")?{icon:"🔄",label:this._t("event.substitution"),cls:"sub"}:a.includes("var")?{icon:"📺",label:this._t("event.var"),cls:"meta"}:{icon:"·",label:e.type_text||this._t("timeline.event"),cls:"meta"}}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return R`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.key_events||e.attributes.key_events||[];if(0===i.length)return R`
      ...
      `;let s=this.reverseOrder?[...i].reverse():i;return this.showOnlyKey&&(s=s.filter((e=>{const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return e.scoring_play||"goal"===t||a.includes("goal")||a.includes("yellow card")||a.includes("red card")}))),this.maxEvents>0&&(s=s.slice(0,this.maxEvents)),R`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":R`
          <div class="tl-header">
        ...
        <div class="tl-body">
          ${s.map((e=>{const t=this._eventMeta(e),i=a.home_team&&e.team===a.home_team,s=a.away_team&&e.team===a.away_team,n=i?"home":s?"away":"meta",o=(e.athletes||[]).filter(Boolean);return R`
    ...
    `}}),customElements.define("sports-live-bracket",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.compactMode=!0===e.compact,this._cardStyle="tree"===e.style?"tree":"list",this.treeShowPlayoffs=!0===e.tree_show_playoffs}_t(e,t){return pe(e,de(this.hass,this._config),t)}_formatDate(e){if(!e)return"";try{const t=new Date(e),a=this._t("month."+(t.getMonth()+1));return`${t.getDate()} ${a}`}catch(e){return""}}_localizeRoundName(e){const t={Final:"round.final",Semifinals:"round.semifinals",Quarterfinals:"round.quarterfinals","Round of 16":"round.r16","Round of 32":"round.r32","Knockout Playoffs":"round.knockout_playoffs","Preliminary Round":"round.preliminary"}[e.name];return t?this._t(t):e.name}getCardSize(){return 6}static getConfigElement(){return document.createElement("sports-live-bracket-editor")}static getStubConfig(){return{entity:"",hide_header:!1,compact:!1,style:"list"}}_formatScore(e){return null==e?"-":String(e)}_renderTie(e){const t=e.team_a||{},a=e.team_b||{},i=e.leg1,s=e.leg2,n=e.single,o=e.winner_team,r=o&&t.name&&o===t.name,l=o&&a.name&&o===a.name,c=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null,d=c(i,t),p=c(i,a),h=c(s,t),g=c(s,a),u=c(n,t),f=c(n,a),m=i&&"in"===i.state||s&&"in"===s.state||n&&"in"===n.state,v=!i&&!n;return R`
      <div class="tie ${m?"live":""} ${e.completed?"done":""}">
        <div class="tie-row ${r?"winner":""} ${l?"loser":""}">
          ...
          <span class="legs">
            ${n?R`<span class="leg">${this._formatScore(u)}</span>`:R`
        ...
        <div class="tie-row ${l?"winner":""} ${r?"loser":""}">
          ...
          <span class="legs">
            ${n?R`<span class="leg">${this._formatScore(f)}</span>`:R`
        ...
        <div class="tie-foot">
          ${m?R`<span class="live-badge"><span class="dot"></span>LIVE</span>`:""}
          ...
          ${e.completed||m||!e.first_leg_date?"":R`<span class="date">${this._formatDate(e.first_leg_date)}</span>`}
    ...
    `}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">Entità sconosciuta: ${this._config.entity}</ha-card>`;const t=e.attributes.rounds||[];return 0===t.length?R`
        <ha-card class="empty">
          <div class="hero-bg"></div>
          <div class="empty-state">
            <div class="empty-icon">🏆</div>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"sports-live-bracket",name:"Sports Live Bracket",description:"Knockout bracket for cup competitions."}),customElements.define("sports-live-bracket-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 12px; color: var(--secondary-text-color); }
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>{if(!e.startsWith("sensor."))return!1;const t=this.hass.states[e]?.attributes;return void 0!==t?.sport&&Array.isArray(t?.rounds)})).sort())}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}_renderDownDistance(e){return e.down_distance_text?R`<div class="down-distance">${e.down_distance_text}</div>`:""}_renderTimeouts(e){const t=e.home_timeouts,a=e.away_timeouts;if(null==t&&null==a)return"";const i=e=>{const t=parseInt(e,10)||0;return Array.from({length:3},((e,a)=>R`
    ...
    `}_renderBaseball(e){const{balls:t,strikes:a,outs:i,on_first:s,on_second:n,on_third:o}=e;return null==t&&null==a&&null==i?"":R`
    ...
    `}_renderLastPlay(e){return e.last_play?R`
      <div class="last-play-wrap">
        <span class="last-play-text">${e.last_play}</span>
      </div>
    `:""}_renderPeriodLabel(e){const t=e.period;if(!t||"N/A"===t)return"";const a=parseInt(t,10),i=(e.status||"").toLowerCase();if(i.includes("half")||i.includes("over")||i.includes("end"))return R`<div class="period-label">${e.status}</div>`;const s=["st","nd","rd","th"][Math.min(a-1,3)]||"th";return R`<div class="period-label">${a}${s}</div>`}_renderOdds(e){return this._config.show_odds&&(e.odds_details||null!=e.over_under)?R`
      <div class="odds-row">
        ${e.odds_details?R`<span class="odds-chip">${e.odds_details}</span>`:""}
        ${null!=e.over_under?R`<span class="odds-chip">O/U ${e.over_under}</span>`:""}
      </div>
    `:""}_renderPopup(e,t,a,i){if(!this._popupOpen)return"";const s=this._getBroadcast(e),n=e.match_details||[];return R`
      ...
      >
        <div class="popup">
          ...
          <div class="popup-body">
            ${e.status_detail?R`<div class="popup-row"><span class="popup-label">Status</span><span>${e.status_detail}</span></div>`:""}
            ${e.venue?R`<div class="popup-row"><span class="popup-label">Venue</span><span>${e.venue}${e.venue_city?`, ${e.venue_city}`:""}</span></div>`:""}
            ${e.date?R`<div class="popup-row"><span class="popup-label">Date</span><span>${e.date}</span></div>`:""}
            ${e.attendance?R`<div class="popup-row"><span class="popup-label">Attendance</span><span>${Number(e.attendance).toLocaleString()}</span></div>`:""}
            ${s?R`<div class="popup-row"><span class="popup-label">TV</span><span>${s}</span></div>`:""}
            ${e.odds_details?R`<div class="popup-row"><span class="popup-label">Odds</span><span>${e.odds_details}</span></div>`:""}
            ${null!=e.over_under?R`<div class="popup-row"><span class="popup-label">O/U</span><span>${e.over_under}</span></div>`:""}
            ${null!=e.home_win_probability?R`<div class="popup-row"><span class="popup-label">${e.home_abbrev||"Home"} win%</span><span>${parseFloat(e.home_win_probability).toFixed(0)}%</span></div>`:""}
            ${e.home_record?R`<div class="popup-row"><span class="popup-label">${e.home_abbrev||"Home"}</span><span>${e.home_record}</span></div>`:""}
            ${e.away_record?R`<div class="popup-row"><span class="popup-label">${e.away_abbrev||"Away"}</span><span>${e.away_record}</span></div>`:""}
            ${n.length?R`
              <div class="popup-section">Events</div>
              ${n.slice(0,6).map((e=>R`<div class="popup-event">${e}</div>`))}
            `:""}
            ${t?R`
    ...
    `}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">Unknown entity: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(!t.length)return R`<ha-card class="empty">No match data available</ha-card>`;const a=t[0],i="in"===a.state,s="post"===a.state,n=!i&&!s,o=i||s,r=a.event_url||"",l=!1!==this._config.show_stadium,c=!1!==this._config.show_countdown,d=!1!==this._config.show_popup,p=this._toHex(a.home_color)||"#6366f1",h=this._toHex(a.away_color)||"#ec4899",g=this._getTeamUrl(a.home_logo),u=this._getTeamUrl(a.away_logo),f=this._config.score_size||"normal",m=c&&n?this._countdown(a.date_iso):"";return R`
      <ha-card
      ...
      >
        ...
        <div class="top-bar">
          ...
          ${i?R`<span class="badge live-badge"><span class="dot"></span>LIVE</span>`:s?R`<span class="badge ft-badge">FINAL</span>`:R`<span class="badge pre-badge">${a.date||"Upcoming"}</span>`}
        </div>
        ...
        <div class="scoreboard">
          <div class="team">
            ...
            ${a.home_record?R`<div class="record">${a.home_record}</div>`:""}
          </div>
          ...
          <div class="center">
            ...
            <div class="clock-row">
              ${i?R`<span class="clock clk-live"><span class="dot"></span>${a.clock&&"N/A"!==a.clock?a.clock:a.status||""}</span>`:s?R`<span class="clock clk-ft">Full Time</span>`:R`<span class="clock clk-pre">${a.date||""}</span>`}
            </div>
          ...
          <div class="team">
            ...
            ${a.away_record?R`<div class="record">${a.away_record}</div>`:""}
          </div>
        </div>

        ${n&&l&&a.venue?R`<div class="stadium">${a.venue}${a.venue_city?" · "+a.venue_city:""}</div>`:""}
        ${n&&m?R`<div class="countdown">${m}</div>`:""}
        ...
        ${s&&l&&a.venue?R`<div class="stadium">${a.venue}${a.venue_city?" · "+a.venue_city:""}</div>`:""}
